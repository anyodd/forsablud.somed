          ...
          <div class="card-body px-2 py-2">
            ...
            <form action="{{ route('sisaup.store') }}" method="post" class="form-horizontal">
              ...
              <div class="card-body">
                ...
                {{-- modal Cari Otorisasi --}}
                  <div class="row form-group">
                      <div class="col-sm-2">
                        <label for="NoOto">Data Otorisasi</label>
                      </div>
                      <div class="col-sm">
                        <div class="input-group input-group-sm-1">
                            <input type="text" class="form-control" id="Ur_Keg2" name="Ur_Keg2">
                            <span class="input-group-append">
                            <button type="button" class="btn btn-info btn-flat" data-toggle="modal" data-target="#modalCariOtorisasi">Cari!</button>
                            </span>
                        </div>
                      </div>
                  </div>
                  {{-- END Cari Otorisasi--}}
                  <div class="form-group row">
                      <label for="Ko_sKeg1" class="col-sm-2 col-form-label">Nomor Otorisasi</label>
                      <div class="col-sm-2">
                          <input type="text" name="No_oto" class="form-control text-right" id="dNo_oto" readonly>
                      </div> 
                  </div>
                  <div class="form-group row">
                    <label for="" class="col-sm-2 col-form-label">Nilai Penyetoran Kas (Rp)</label>
                    <div class="col-sm">
                    <input type="number" name="sikas_Rp" class="form-control" value="">
                    </div>
                  </div>
...
@include('transaksi.penyetoran.popup.modal_cari_otorisasi')
@endsection
