      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          <div class="card-header bg-info py-2">
            <h5 class="card-title font-weight-bold">@yield('title') Panjar</h5> 
          </div>

          <div class="card-body px-2 py-2">
              <a href="{{ route('sisapanjar.create') }}">
              ...
              <table class="table table-sm table-bordered table-hover mb-0" id="example" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $data->sikas_ur }}</td>                                          
                    <td class="text-center">{{ date('d M Y', strtotime($data->dt_sikas)) }}</td>                      
                    <td class="text-right">{{ number_format($data->sikas_Rp,0,',','.'); }}</td>                                      
                    <td>
                      <div class="row justify-content-center" >
                        <div class="col-sm-4">
                            <a href="/sisapanjar/edit/{{$data->id_sikas}}">
                              <button class="btn btn-warning btn-block" style="display: flex; align-items: center; justify-content: center;" title="Edit">
                              <i class="fas fa-edit"></i></button>
                            </a>
                        </div>
                        <div class="col-sm-4">
                            <a href="{{ route('sisapanjar.destroy', $data->id_sikas) }}">
                              <button class="btn btn-danger btn-block" style="display: flex; align-items: center; justify-content: center;" title="Hapus">
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              <form action="{{ route('sisapanjar.destroy', $data->id_sikas) }}" method="post" class="">
                                <!-- @csrf
                                @method('DELETE')
