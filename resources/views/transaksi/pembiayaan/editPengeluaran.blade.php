<div class="modal fade" id="modal-editPengeluaran{{$item2->id_bp}}">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">@yield('title') Pengeluaran</h4>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card card-info">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form action="{{ route('pembiayaan.update', $item2->id_bp) }}" method="POST">
                                        @csrf
                                        @method("PUT")
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="date" name="dt_bp" placeholder="Tanggal "
                                                    ...
                                                    value="{{ old('dt_bp', $item2->dt_bp) ?? '' }}" min="{{ Tahun().'-01-01' }}" max="{{ Tahun().'-12-31' }}">
                                                @error('dt_bp')
                                                    <div class="invalid-feedback"> {{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="nm_BUcontr" placeholder="Nama Pihak ketiga"
                                                    ...
                                                    value="{{ old('nm_BUcontr', $item2->nm_BUcontr) ?? '' }}">
                                                @error('nm_BUcontr')
                                                    <div class="invalid-feedback"> {{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="adr_bucontr" placeholder="Alamat Pihak ketiga"
                                                    ...
                                                    value="{{ old('adr_bucontr', $item2->adr_bucontr) ?? '' }}">
                                                @error('adr_bucontr')
                                                    <div class="invalid-feedback"> {{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-10">
                                                {{-- <input type="text" name="Nm_input"
                                                    ...
                                                    value="{{ old('Nm_input', $item2->Nm_input) ?? '' }}"> --}}
                                                <select class="form-control select2  @error('Nm_input') is-invalid @enderror" name="Nm_input">
                                                    @foreach ($pegawai as $ls)
                                                        <option value="{{$ls->nama}}" {{$ls->nama == $item2->Nm_input ? 'selected' : ''}}>{{$ls->nama}} ({{$ls->jabatan}})</option>
                                                    @endforeach
                                                </select>
                                                @error('Nm_input')
                                                    <div class="invalid-feedback"> {{ $message }}</div>
