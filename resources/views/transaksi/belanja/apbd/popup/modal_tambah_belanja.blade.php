<div class="modal fade" id="modalTambahBelanja" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="col-sm">
                                                    <input type="text" name="No_bp" class="form-control" value="" placeholder="Isikan Nomor Dokumen">
                                                </div>
                                                </div>
                                                <div class="form-group row">
                                                <label for="" class="col-sm-2 col-form-label">Tanggal Dokumen</label>
                                                <div class="col-sm">
                                                    <input type="date" name="dt_bp" class="form-control" value="" >
                                                </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="col-sm">
                                                    <input type="text" name="nm_BUcntr" class="form-control" value="" placeholder="Isikan Nama Pihak Lain">
                                                </div>
                                                </div>
                                                <div class="form-group row">
                                                <label for="" class="col-sm-2 col-form-label">Alamat Pihak Lain</label>
                                                <div class="col-sm">
                                                <input type="text" name="adr_bucntr" class="form-control" value="" placeholder="Isikan Alamat Pihak Lain">
                                                </div>
                                                </div>
                                            </div>
                                        </div>
