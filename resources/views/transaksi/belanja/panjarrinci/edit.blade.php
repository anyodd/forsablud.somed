            ...
            <div class="col">
                <div class="card shadow-lg mt-2">
                    ...
                    <div class="card-body px-2 py-2">
                        ...
                        <form action="{{ route('panjar-rinci.update', $panjar->id_bprc) }}" method="post" class="form-horizontal">
                            @csrf
                            @method("PUT")
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-1">
                                        <input type="text" name="Ko_bprc"
                                            ...
                                            value="{{$panjar->Ko_bprc}}" id="Ko_bprc" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" name="To_Rp1" class="form-control text-right" id="To_Rp1" value="{{old('To_Rp1', number_format($dt_view->spirc_Rp,2,',','.'))}}" readonly>
                                    </div> 
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" name="Ko_sKeg1" class="form-control" id="sKo_sKeg1" value="{{old('Ko_sKeg1', $panjar->Ko_sKeg1)}}" readonly>
                                    </div> 
                                    <div class="col-sm-7">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" name="Ko_sKeg2" class="form-control" id="sKo_sKeg2" value="{{old('Ko_sKeg2', $panjar->Ko_sKeg2)}}"readonly>
                                    </div>                                                                      
                                    <div class="col-sm-7">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" name="Ko_Rkk" class="form-control" id="sKo_Rkk" value="{{old('Ko_Rkk', $panjar->Ko_Rkk)}}" readonly>
                                    </div> 
                                    <div class="col-sm-7">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="Ur_bprc"
                                            ...
                                            value="{{ old('Ur_bprc', $panjar->Ur_bprc) }}">
                                        @error('Ur_bprc')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="rftr_bprc"
                                            ...
                                            value="{{ old('rftr_bprc', $panjar->rftr_bprc) }}">
                                        @error('rftr_bprc')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" name="dt_rftrbprc"
                                            ...
                                            id="dt_rftrbprc" value="{{ old('dt_rftrbprc', $panjar->dt_rftrbprc) }}" min="{{ Tahun().'-01-01' }}" max="{{ Tahun().'-12-31' }}">
                                        @error('dt_rftrbprc')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select id="Ko_kas" name="Ko_kas"
                                            ...
                                            <option value="1" {{$panjar->ko_kas == 1 ? 'selected' : ''}}>Pindah Buku</option>
                                            <option value="2" {{$panjar->ko_kas == 2 ? 'selected' : ''}}>Tunai Fisik</option>
                                        </select>
                                        @error('Ko_kas')
                                        <div class="invalid-feedback"> {{ $message }}</div>
                                        @enderror
