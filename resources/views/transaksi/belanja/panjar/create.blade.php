      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          <div class="card-header bg-info py-2">
            <h5 class="card-title font-weight-bold">Tambah Data Panjar</h5>
          </div>

          <div class="card-body px-2 py-2">

            <form action="{{ route('panjar.store') }}" method="post" class="form-horizontal">
              @csrf
              @if(session('errors'))
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm">
                    <input type="text" name="NoBp" class="form-control @error('NoBp') is-invalid @enderror"
                      value="{{ old('NoBp') }}" placeholder="Masukan Nomor Dokumen">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm">
                    <input type="text" name="UrBp" class="form-control @error('UrBp') is-invalid @enderror"
                      value="{{old('UrBp')}}" placeholder="Keterangan Transaksi">
                  </div>
                </div>
                <div class="form-group row">
