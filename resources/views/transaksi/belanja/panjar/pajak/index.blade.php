      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          ...
          <div class="card-body px-2 py-2">
            ...
            <a href="{{route('panjar.index')}}" class="btn btn-info btn-sm mb-2"><i class="fas fa-reply"></i> Kembali</a>
              ...
              <table class="table table-sm table-bordered table-hover mb-0" id="example" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $pajak->No_bp }}</td>                       
                    <td>{{ $pajak->Ko_tax }}</td>                      
                    <td class="text-center">{{ $pajak->Ko_Rkk }}</td>                      
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              <form action="{{route('panjar.destroyPajak',$pajak->id_tax)}}" method="post" class="">
                                @csrf
                                @method('DELETE')
                    ...
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Potong Pajak Panjar</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="card card-info">
                                                ...
                                                <!-- /.card-header -->
                                                <div class="card-body">
                                                    <form action="{{route('panjar.editpotongpajak',$pajak->id_tax)}}" method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="row form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="input-group input-group-sm">
                                                                    <input type="text" class="form-control" name="id_bp" value="{{$panjar->id_bp}}" readonly>
                                                                    <input type="text" class="form-control" name="No_bp" value="{{$panjar->No_bp}}" readonly>
                                                                    <input type="text" class="form-control" name="Ur_bp" value="{{$panjar->Ur_bp}}" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="input-group input-group-sm">
                                                                    <input type="text" class="form-control" name="Ko_Period" value="{{$panjar->Ko_Period}}" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="input-group input-group-sm">
                                                                    <input type="text" class="form-control" name="Ko_unit1" value="{{$panjar->Ko_unit1}}" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="input-group input-group-sm">
                                                                    <input type="text" class="form-control" name="Ko_bp" value="{{$panjar->Ko_bp}}" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-info">
                                            ...
                                            <!-- /.card-header -->
                                            <div class="card-body">
                                                <form action="{{route('panjar.potongpajak')}}" method="POST">
                                                    @csrf
                                                    <div class="row form-group">
                                                        <div class="col-md-2">
                                                            <label for="No_byr">Kode/No/Uraian BP</label>
...
@include('transaksi.belanja.panjar.pajak.popup.rekening')
@endsection
