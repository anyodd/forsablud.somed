      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          <div class="card-header bg-info py-2">
            <h5 class="card-title font-weight-bold">Edit Data Panjar</h5>
          </div>

          <div class="card-body px-2 py-2">

            <form action="{{ route('panjar.update',$data->id_bp) }}" method="post" class="form-horizontal">
              @csrf
              @method('PUT')
              @if(session('errors'))
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm">
                    <input type="text" name="NoBp" class="form-control @error('NoBp') is-invalid @enderror"
                      value="{{ old('NoBp',$data->No_bp) }}" placeholder="Masukan Nomor Dokumen">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="" class="col-sm-2 col-form-label">Tanggal Dokumen</label>
                  <div class="col-sm">
                    <input type="date" name="DtBp" class="form-control @error('DtBp') is-invalid @enderror"
                      value="{{ old('DtBp',$data->dt_bp) }}" min="{{ Tahun().'-01-01' }}" max="{{ Tahun().'-12-31' }}">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="" class="col-sm-2 col-form-label">Uraian</label>
                  <div class="col-sm">
                    <input type="text" name="UrBp" class="form-control @error('UrBp') is-invalid @enderror"
                      value="{{old('UrBp',$data->Ur_bp)}}" placeholder="Keterangan Transaksi">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row justify-content-center mt-3">
                  ...
                  <a href="{{ route('panjar.index') }}" class="col-sm-2 btn btn-danger ml-3">
