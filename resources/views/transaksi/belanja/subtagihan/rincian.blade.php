      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          ...
          <div class="card-body px-2 py-2">
            <div class="card-body">
              <a href="{{ route('subtagihan.tambah', Request::segment(3)) }}">
              ...
              <a href="{{route('tagihan.pajak', $idbp)}}">
              ...
              <a href="{{ route('tagihan.bulan',Session::get('bulan')) }}" class="btn btn-sm btn-success float-right">
                  ...
                  <tr>
                    ...
                    <div class="modal fade" id="modal2{{ $r->id_bprc }}"
                      ...
                      <div class="modal-footer">
                        <form
                        action="{{ route('subtagihan.destroy', $r->id_bprc) }}" method="post" class="">
                        @csrf
                        @method('DELETE')
...
@include('transaksi.belanja.subtagihan.popup.rekening')
