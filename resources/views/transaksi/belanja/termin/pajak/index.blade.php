          ...
          <div class="card-body px-2 py-2">
            <div class="row">
              <table class="table-borderless table-sm text-nowrap">
                <tbody>
                  <tr>
                    <td style="width: 10px"><b>No. Termin</b></td>
            ...
            <a href="{{route('subtermin.rincian',$termin->id_bp)}}" class="btn btn-info btn-sm mb-2"><i class="fas fa-reply"></i> Kembali</a>
              ...
              <table class="table table-sm table-bordered table-hover mb-0" id="example" width="100%" cellspacing="0">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th class="text-center" style="vertical-align: middle">No Termin</th>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              <form action="{{route('termin.destroyPajak',$pajak->id_tax)}}" method="post" class="">
                                @csrf
                                @method('DELETE')
                    ...
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Potong Pajak Termin</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="card card-info">
                                                ...
                                                <!-- /.card-header -->
                                                <div class="card-body">
                                                    <form action="{{route('termin.editpotongpajak',$pajak->id_tax)}}" method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="row form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="input-group input-group-sm">
                                                                    <input type="text" class="form-control" name="id_bp" value="{{$termin->id_bp}}" readonly>
                                                                    <input type="text" class="form-control" name="No_bp" value="{{$termin->No_bp}}" readonly>
                                                                    <input type="text" class="form-control" name="Ur_bp" value="{{$termin->Ur_bp}}" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="input-group input-group-sm">
                                                                    <input type="text" class="form-control" name="Ko_Period" value="{{$termin->Ko_Period}}" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="input-group input-group-sm">
                                                                    <input type="text" class="form-control" name="Ko_unit1" value="{{$termin->Ko_unit1}}" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="input-group input-group-sm">
                                                                    <input type="text" class="form-control" name="Ko_bp" value="{{$termin->Ko_bp}}" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="input-group input-group-sm">
                                                                    <input type="text" class="form-control" id="Ko_Rkk" name="Ko_Rkk" value="{{$pajak->Ko_Rkk}}"
                                                                        readonly>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-info">
                                            ...
                                            <!-- /.card-header -->
                                            <div class="card-body">
                                                <form action="{{route('termin.potongpajak')}}" method="POST">
                                                    @csrf
                                                    <div class="row form-group">
                                                        <div class="col-md-2">
                                                            <label for="No_byr">Kode/No/Uraian BP</label>
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="input-group input-group-sm">
                                                                <input type="text" class="form-control" id="Ko_Rkk_edit" name="Ko_Rkk"
                                                                     required>
                                                                <span class="input-group-append">
                                                                    <button type="button" class="btn btn-info btn-flat"
                                                                        data-toggle="modal"
...
@include('transaksi.belanja.termin.pajak.popup.rekening')
@endsection
