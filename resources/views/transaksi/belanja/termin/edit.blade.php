      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          <div class="card-header bg-info py-2">
            <h5 class="card-title font-weight-bold">Edit Data Termin</h5> 
          </div>

          <div class="card-body px-2 py-2">

            <form action="{{ route('termin.update',$data->id_bp) }}" method="post" class="form-horizontal">
              @csrf
              @method('PUT')
              @if(session('errors'))
              ...
              <div class="card-body">
                <div class="form-group row">
                  ...
                  <div class="col-sm">
                    <input type="text" class="form-control" value="{{old('No_contr',$data->No_contr)}}" readonly>
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm">
                    <input type="text" class="form-control" value="{{old('rekan_nm', $data->rekan_nm)}}" readonly>
                  </div>
                </div>
