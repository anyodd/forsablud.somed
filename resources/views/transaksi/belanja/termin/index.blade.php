      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          <div class="card-header bg-info py-2">
            <h5 class="card-title font-weight-bold">Daftar Termin</h5> 
          </div>

          <div class="card-body px-2 py-2">
              <a href="{{ route('termin.create') }}">
              ...
              <table class="table table-sm table-bordered table-hover mb-0" id="example" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-right">{{ number_format($belanja->Total,2,',','.') }}</td>                     
                    <td class="text-right">{{ number_format($belanja->t_tax,2,',','.') }}</td>                     
                    <td>
                      <div class="row justify-content-center" >
                        <div class="col-sm-3">
                            <a href="{{ route('subtermin.rincian', $belanja->id_bp)}} ">
                              <button class="btn btn-sm btn-outline-info" style="display: flex; align-items: center; justify-content: center;"
                              title="Detail">
                              <i class="fas fa-angle-double-right"></i></button>
                            </a>
                        </div>
                        {{-- <div class="col-sm-3">
                          <a href="{{route('termin.pajak', $belanja->id_bp)}}">
                        ...
                        <div class="col-sm-3">
                            <a href="{{route('termin.edit',$belanja->id_bp)}}">
                        ...
                        @if ($belanja->Total == 0)
                          <div class="col-sm-3">
                            <button class="btn btn-sm btn-outline-danger" data-toggle="modal" data-target="#modal{{ $belanja->id_bp }}" 
                              style="display: flex; align-items: center; justify-content: center;"
                              title="Hapus">
                      ...
                      <div class="modal fade" id="modal{{ $belanja->id_bp }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              <form action="{{ route('termin.destroy', $belanja->id_bp) }}" method="post" class="">
                                @csrf
                                @method('DELETE')
