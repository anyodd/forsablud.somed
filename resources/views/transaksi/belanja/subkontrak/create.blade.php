      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          ...
          <div class="card-body px-2 py-2">
            ...
            <form action="{{ route('subkontrak.store') }}" method="post" class="form-horizontal">
              @csrf
              @if(session('errors'))
              ...
              <div class="card-body">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-1">
                          <input type="text" name="Ko_contrc" class="form-control" value="{{$max+1}}" id="Ko_contrc" readonly>
                      </div> 
                  </div>
                  {{-- modal Kegiatan APBD --}}
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-2">
                          <input type="text" name="To_Rp2" class="form-control text-right" id="To_Rp" value="{{old('To_Rp2')}}" readonly>
                      </div> 
                  </div>
                  <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                          <input type="text" name="Ur_sKeg1" class="form-control" id="Ur_KegBL1" value="{{old('Ur_sKeg1', $data->Ur_sKeg1)}}" readonly>
                      </div> 
                  </div>
                  <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                          <input type="text" name="Ur_sKeg2" class="form-control" id="Ur_KegBL2" value="{{old('Ur_sKeg2', $data->Ur_sKeg2)}}" readonly>
                      </div>  
                  </div>
                  <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                          <input type="text" name="Ur_Rk6" class="form-control" id="Ur_Rk6"  value="{{old('Ur_Rk6', $data->Ur_Rk6)}}" readonly>
                      </div> 
                  </div>
                  <hr>
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                          <input type="text" name="To_Rp" class="form-control desimal" id="To_Rp2" value="{{old('To_Rp')}}">
                      </div>
                  </div>
