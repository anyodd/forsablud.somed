      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          <div class="card-header bg-info py-2">
            <h5 class="card-title font-weight-bold">Edit Data</h5> 
          </div>

          <div class="card-body px-2 py-2">

            <form action="{{ route('subapbd.update', $data->id_bprc) }}" method="POST" class="form-horizontal">
              @csrf
              @method("PUT")
              @if(session('errors'))
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-2">
                    ...
                    <input type="text" name="Ko_Pdp" class="form-control text-right" id="sKo_Pdp" value="{{old('Ko_Pdp', $dt_view->Ko_Pdp)}}" hidden readonly>
                  </div> 
                </div>
                <div class="form-group row">
