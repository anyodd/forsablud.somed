      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          <div class="card-header bg-info py-2">
            <h5 class="card-title font-weight-bold">Tambah Data</h5> 
          </div>

          <div class="card-body px-2 py-2">

            <form action="{{ route('subapbd.store') }}" method="post" class="form-horizontal">
              @csrf
              @if(session('errors'))
              ...
              <div class="card-body">
                  <div class="form-group row">
                      <label for="nomorSpd" class="col-sm-3 col-form-label">Nomor SP2D</label>
                      <div class="col-sm-3">
                          <input type="text" name="No_bp" class="form-control" value="{{old('No_bp', $data->No_bp)}}" id="nomorBukti" readonly>
                      </div>
                  </div>
                  <input type="text" name="id_bp" class="form-control" value="{{old('id_bp', $data->id_bp)}}" id="IdBp" readonly hidden>
                  ...
                  <div class="row form-group">
                      <div class="col-sm-3">
                        <label for="KegApbd">Cari Rincian APBD</label>
                      </div>
                      <div class="col-sm-9">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                          <input type="text" name="rftr_bprc" class="form-control" id="rftr_bprc">
                      </div> 
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                          <input type="text" name="To_Rp" class="form-control" id="To_Rp">
                      </div>
                  </div>
                  <div class="form-group row">
