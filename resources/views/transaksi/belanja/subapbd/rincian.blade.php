...
@section('title', 'Rincian Bukti Belanja APBD')
@section('style') 
      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          <div class="card-header bg-info py-2">
            <h5 class="card-title font-weight-bold">Rincian Bukti Belanja APBD  - SP2D</h5> 
          </div>

          <div class="card-body px-2 py-2">
            <div class="card-body">
                <a href="{{ route('subapbd.tambah', Request::segment(3)) }}">
                  <button class="btn btn-sm btn-primary">
                    <i class="fas fa-plus-circle pr-1"></i>
                    Tambah 
                  </button>
                </a>
                <a href="{{ route('apbd.bulan',Session::get('bulan'))}}" class="btn btn-sm btn-success float-right">
              ...
              <table class="table table-sm table-bordered table-hover mb-0" id="example" width="100%" cellspacing="0">
                <thead class="thead-light">
                  <tr>
                    <th class="text-center">No Rincian</th>
                ...
                <tbody>
                  ...
                  <tr>
                    <td class="text-center" style="width: 3%">{{ $r->Ko_bprc }}</td>                       
                    <td>{{ $r->No_bp }}</td>                      
                    <td>{{ $r->Ur_bprc }}</td>                      
                    <td>{{ $r->rftr_bprc }}</td>                      
                    ...
                    <td>
                      <div class="row justify-content-center" >
                        <div class="col-sm-4">
                            <a href="{{ route('subapbd.edit', $r->id_bprc)}}">
                          ...
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                <form action="{{ route('subapbd.destroy', $r->id_bprc) }}" method="post" class="">
                                  @csrf
                                  @method('DELETE')
