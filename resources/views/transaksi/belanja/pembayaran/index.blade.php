      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          <div class="card-header bg-info py-2">
            <h5 class="card-title font-weight-bold">Data Pembayaran</h5> 
          </div>
              ...
              <table class="table table-sm table-bordered table-hover mb-0" id="example" width="100%" cellspacing="0">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th class="text-center" style="vertical-align: middle;">Nomor Bayar</th>
                    ...
                    <th class="text-center" style="vertical-align: middle;">Nilai Pembayaran (Rp)</th>
                          ...
                          <div class="modal-dialog modal-dialog-centered"
                              ...
                              <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                      <form
                                          action="{{ route('pembayaran.destroy', $item->id_bp) }}"
                                          method="post">
                                          @csrf
                                          @method('DELETE')
                                          <button type="submit"
...
<script>
    ...
    function Mymonth()
    {
      var slug = $('#bulan').val();
      console.log(slug);
      var url = '{{ route("pembayaran.bulan", ":slug") }}';
