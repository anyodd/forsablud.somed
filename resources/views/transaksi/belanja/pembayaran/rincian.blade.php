      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          ...
          <div class="card-body px-2 py-2">
            <div class="card-body">
            <a href="{{ route('pembayaran.bulan',Session::get('bulan'))}}" class="btn btn-sm btn-success float-right">
                  ...
                  <td class="text-center">{{ $r->Ko_Period }}</td>                       
                    ...
                    <td>
                      <div class="row justify-content-center" >
                        <div class="col-sm-4">
                            <a href="#">
                              <button class="btn btn-danger btn-block" data-toggle="modal" data-target="#modalHapus{{ $r->id_byr }}" style="display: flex; align-items: center; justify-content: center;" title="Hapus">
                              <i class="fas fa-trash-alt"></i></button>
                            </a>
                        </div>
                      <div class="modal fade" id="modalHapus{{ $r->id_byr }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              <form action="{{ route('subpembayaran.destroy', $r->id_byr) }}" method="post" class="">
                                @csrf
                                @method('DELETE')
