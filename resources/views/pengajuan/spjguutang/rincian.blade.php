...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ route('spjguutang.index') }}">SPJ GU</a></li>
              ...
              <table class="table table-sm table-bordered table-hover mb-0" id="example" width="100%" cellspacing="0">
                ...
                <?php $no++ ;?>
                  <tr>              
                    ...
                    <td class="text-center" style="vertical-align: middle">{{ $spjgu2->Ur_bprc }}</td>                                     
                    <td class="text-center" style="vertical-align: middle">{{ number_format($spjgu2->spirc_Rp,2,',','.') }}</td>                 
                    <td>
                    <div class="row justify-content-center" >
                        ...
                        <div class="modal-dialog modal-xl">
                          <div class="modal-content">
                              <div class="modal-header">
                                  <h5 class="modal-title font-weight-bold" id="exampleModalLabel">Detail Rincian Ls Tagihan Nomor: {{ $spjgu2->No_spi }} </h5>
                              </div>
                      ...
                      <div class="modal fade" id="modal2{{ $spjgu2->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <h6>Yakin mau hapus rincian LS Tagihan dengan nomor tagihan {{ $spjgu2->No_bp }} {{ $spjgu2->id }} ?</h6>
                            </div>
                            <div class="modal-footer">
                                <form action="{{ route('hapusrinciantagihanutang', $spjgu2->id) }} " method="post" class="">
                                @csrf
                                @method('DELETE')
