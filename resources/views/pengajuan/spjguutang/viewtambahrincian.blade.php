...
@include('pengajuan.spjguutang.popup.modal_bukti_spjguutang')

<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
    <li class="breadcrumb-item"><a href="{{ route('spjguutang.index') }}">LS Tagihan</a></li>
      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          ...
          <div class="card-body px-2 py-2">
            <form action="{{ route('spjguutang.tambahrincian')}}" method="post">
                @csrf
                @if(session('errors'))
              ...
              @endif
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <input type="text" name="No_spi" class="form-control @error('No_SPi') is-invalid @enderror" value="{{ old('No_SPi', $spjguutang->No_SPi) }}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <span class="input-group-append">
                                        <button type="button" class="btn btn-info btn-flat" data-toggle="modal" data-target="#modalBuktispjguutang">Pilih.....</button>
                                        </span>
                                    </div>
                                    <div class="col-sm-9">
                    ...
                    <div class="form-group row justify-content-center mt-3">
                        ...
                        <a href="{{ route('spjguutang.index') }}" class="col-sm-2 btn btn-danger ml-3">
