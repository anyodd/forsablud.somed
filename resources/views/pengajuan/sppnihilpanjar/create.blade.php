			...
			<div class="col">
				<div class="card shadow-lg mt-2">
					<div class="card-header bg-info py-2">
						<h5 class="card-title font-weight-bold">TAMBAH DATA SPP NIHIL PANJAR</h5>
					</div>
					<div class="card-body px-2 py-2">
						<form action="{{ route('sppnihilpanjar.store') }}" method="post">
							@csrf
							<div class="card-body">
								<div class="row">
									<div class="col-sm-12">
										...
										<div class="form-group row">
											...
											<div class="col-sm-5">
												<input type="text" name="No_SPi"
													...
													value="{{ old('No_SPi') }}" placeholder="Nomor Bukti">
												@error('No_SPi')
												<div class="invalid-feedback">{{ $message }}</div>
												@enderror
											</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-5">
												<input type="date" name="Dt_SPi"
													...
													value="{{ old('Dt_SPi') }}" placeholder="Tanggal Bukti">
												@error('Dt_SPi')
												<div class="invalid-feedback">{{ $message }}</div>
												@enderror
											</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-5">
												<input type="text" name="Ur_SPi"
													...
													value="{{ old('Ur_SPi') }}" placeholder="Uraian">
												@error('Ur_SPi')
												<div class="invalid-feedback">{{ $message }}</div>
												@enderror
											</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-5">
												{{-- <input type="text" name="Nm_PP"
													...
													value="{{ old('Nm_PP') }}" placeholder="Nama Pengusul"> --}}
											...
											<div class="col-sm">
												<input type="text" name="NIP_PP" id="NIP_PP"
													...
													value="{{ old('NIP_PP') }}" placeholder="NIP Pengusul" readonly>
												@error('NIP_PP')
												<div class="invalid-feedback">{{ $message }}</div>
												@enderror
											</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-5">
												{{-- <input type="text" name="Nm_Ben"
													...
													value="{{ old('Nm_Ben') }}" placeholder="Nama Bendahara"> --}}
											...
											<div class="col-sm">
												<input type="text" name="NIP_Ben" id="NIP_Ben"
													...
													value="{{ old('NIP_Ben') }}" placeholder="NIP Bendahara" readonly>
												@error('NIP_Ben')
												<div class="invalid-feedback">{{ $message }}</div>
												@enderror
											</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-5">
												{{-- <input type="text" name="Nm_Keu"
													...
													value="{{ old('Nm_Keu') }}" placeholder="Nama PPK"> --}}
											...
											<div class="col-sm">
												<input type="text" name="NIP_Keu" id="NIP_Keu"
													...
													value="{{ old('NIP_Keu') }}" placeholder="NIP PPK" readonly>
												@error('NIP_Keu')
												<div class="invalid-feedback">{{ $message }}</div>
												@enderror
											</div>
