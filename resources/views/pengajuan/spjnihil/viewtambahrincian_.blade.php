...
@include('pengajuan.spjnihil.popup.modal_bukti_spjnihil')
      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          <div class="card-header bg-info py-2">
            <h5 class="card-title font-weight-bold">Tambah Rincian SPP Nihil</h5> 
          </div>
          <div class="card-body px-2 py-2">
            <form action="{{ route('spjnihil.tambahrincian')}}" method="post">
                @csrf
                @if(session('errors'))
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <input type="text" name="No_spi" class="form-control @error('No_SPi') is-invalid @enderror" value="{{ old('No_SPi', $spjnihil->No_SPi) }}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        ...
                                        <button type="button" class="btn btn-info btn-flat" data-toggle="modal" data-target="#modalBuktiSpjnihil">Pilih.....</button>
                                        </span>
                                    </div>
                                    <div class="col-sm-5">
