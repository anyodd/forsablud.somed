            ...
            <div class="col">
                <div class="card shadow-lg mt-2">
                    ...
                    <div class="card-body px-2 py-2">
                        <form action="{{ route('sppnihilpanjar-rinci.update', $sppnihilpanjar_rinci->id) }}"
                            method="post">
                            @csrf
                            @method('PUT')
                            <div class="card">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text" name="Ko_spirc"
                                                        ...
                                                        value="{{ old('Ko_spirc', $sppnihilpanjar_rinci->Ko_spirc) }}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm">
                                                    <input type="text" name="Ko_sKeg1"
                                                        ...
                                                        id="sKo_sKeg1"
                                                        value="{{ old('Ko_sKeg1', $sppnihilpanjar_rinci->Ko_sKeg1) }}"
                                                ...
                                                <div class="col-sm-5">
                                                    <input type="text" name="Ko_sKeg2"
                                                        ...
                                                        id="sKo_sKeg2"
                                                        value="{{ old('Ko_sKeg2', $sppnihilpanjar_rinci->Ko_sKeg2) }}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm">
                                                    <input type="text" name="Ko_Rkk"
                                                        ...
                                                        id="sKo_Rkk"
                                                        value="{{ old('Ko_Rkk', $sppnihilpanjar_rinci->Ko_Rkk) }}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm">
                                                    <input type="text" name="spirc_Rp"
                                                        ...
                                                        id="sspirc_Rp"
                                                        value="{{ old('spirc_Rp', $sppnihilpanjar_rinci->spirc_Rp) }}"
                                                        placeholder="Nilai (Rp)" readonly>
                                                </div>
                                            </div>
                                            <input type="text" name="pd" class="form-control" id="sPD"
                                                value="{{ old('pd', $sppnihilpanjar_rinci->No_PD) }}" hidden readonly>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card-footer-->
