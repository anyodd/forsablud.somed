...
@include('pengajuan.lsnonkontrak.popup.modal_bukti_lsnonkontrak')
      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          ...
          <div class="card-body px-2 py-2">
            <form action="{{ route('lsnonkontrak.tambahrincian')}}" method="post">
                @csrf
                @if(session('errors'))
              ...
              @endif
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <input type="text" name="No_spi" class="form-control @error('No_SPi') is-invalid @enderror" value="{{ old('No_SPi', $lsnonkontrak->No_SPi) }}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <span class="input-group-append">
                                        <button type="button" class="btn btn-info btn-flat" data-toggle="modal" data-target="#modalBuktiLsnonkontrak">Pilih.....</button>
                                        </span>
                                    </div>
                                    <div class="col-sm-5">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="Ko_bprc" class="form-control @error('Ko_bprc') is-invalid @enderror" id="sKo_bprc" value="{{old('Ko_bprc')  }}"placeholder="No Rincian Tagihan" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-sm-2 col-form-label">No. Ref Tagihan</label>
                                    <label for="" class="col-form-label">:</label>
                                    <div class="col-sm-4">
                                    ...
                                    <label for="" class="col-sm-2 col-form-label">Tgl. Ref. Tagihan</label>
                                    <label for="" class="col-form-label">:</label>
                                    <div class="col-sm">
                    ...
                    <div class="form-group row justify-content-center mt-3">
                        ...
                        <a href="{{ route('lsnonkontrak.bulan',Session::get('bulan')) }}" class="col-sm-2 btn btn-danger ml-3">
