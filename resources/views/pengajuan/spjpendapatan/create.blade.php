      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          <div class="card-header bg-info py-2">
            <h5 class="card-title font-weight-bold">Tambah SPJ Pendapatan</h5> 
          </div>
          <div class="card-body px-2 py-2">
            <form action="{{ route('spjpendapatan.store') }}" method="post">
              @csrf
              @if(session('errors'))
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="" class="col-form-label">:</label>
                            <div class="col-sm-5">
                                <input type="text" name="No_SPi" class="form-control @error('No_SPi') is-invalid @enderror" value="{{ old('No_SPi') }}" placeholder="Nomor SPJ">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <label for="" class="col-form-label">:</label>
                            <div class="col-sm-5">
                                <input type="date" name="Dt_SPi" class="form-control @error('Dt_SPi') is-invalid @enderror" value="{{ old('Dt_SPi') }}" placeholder="Tanggal SPJ">
                            </div>
                        </div>
                        <div class="form-group row">
