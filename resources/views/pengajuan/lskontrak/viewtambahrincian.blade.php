      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          <div class="card-header bg-info py-2">
            <h5 class="card-title font-weight-bold">Rincian LS Kontrak</h5> 
          </div>
          <div class="card-body">
            <div class="card">
            ...
            <div class="row justify-content-center mb-2">
              ...
              <a href="{{ route('lskontrak.index') }}" class="btn btn-info"><i class="fa fa-reply"></i> Kembali</a>
            </div>
...
<script>
  ...
  let route = '{{ URL::route('lskontrak.rincian',':id') }}';
  ...
  $('#btn_tambahrinci').click(function (e) { 
    ...
    let id    = {{tahun()}};
    let route = '{{ URL::route('lskontrak.list_tagihan',':id') }}';
    let url   = route.replace(':id',id);
    var tablelist =
    $('.tablelist').DataTable({
      pageLength  : 25,
  ...
  $('body').on('click','.delete', function () {
    ...
    let route = '{{ URL::route('lskontrak.hapusrinciankontrak',':id') }}';
    let url   = route.replace(':id',id);
  ...
  $(document).on('click','#btn_hapusrinci', function () {
    ...
    Swal.fire({
      ...
      if (result.value) {
        $.ajax({
          type : 'POST',
          url  : '{{route('lskontrak.hapusrincian')}}',
  ...
  $(document).on('click','#submit', function () {
    ...
    $.ajax({
      type : 'POST',
      url  : '{{route('lskontrak.tambahrincian')}}',
