...
@include('pengajuan.lskontrak.popup.modal_bukti_lskontrak')

<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
    <li class="breadcrumb-item"><a href="{{ route('lskontrak.index') }}">Data LS Kontrak/SPK</a></li>
    <li class="breadcrumb-item active pull-right" aria-current="page">Tambah Rincian LS Kontrak/SPK</li>
  </ol>
</nav>
      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          <div class="card-header bg-info py-2">
            <h5 class="card-title font-weight-bold">Tambah Rincian LS Kontrak/SPK</h5> 
          </div>
          <div class="card-body px-2 py-2">
            <form action="{{ route('lskontrak.tambahrincian')}}" method="post">
                @csrf
                @if(session('errors'))
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <input type="text" name="No_spi" class="form-control @error('No_SPi') is-invalid @enderror" value="{{ old('No_SPi', $lskontrak->No_SPi) }}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <span class="input-group-append">
                                        <button type="button" class="btn btn-info btn-flat" data-toggle="modal" data-target="#modalBuktiLskontrak">Pilih.....</button>
                                        </span>
                                    </div>
                                    <div class="col-sm-5">
