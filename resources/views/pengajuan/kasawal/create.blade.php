      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          <div class="card-header bg-info py-2">
            <h5 class="card-title font-weight-bold">TAMBAH KAS AWAL/UP</h5> 
          </div>
          <div class="card-body px-2 py-2">
            <form action="{{ route('kasawal.store') }}" method="post">
              @csrf
              @if(session('errors'))
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="KodeUnit" class="form-control" id="" value="{{ kd_unit() }}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="" class="col-form-label">:</label>
                            <div class="col-sm-5">
                                <input type="date" name="Dt_SPi" class="form-control @error('Dt_SPi') is-invalid @enderror" value="{{ old('Dt_SPi') }}" placeholder="Tanggal SPP">
                            </div>
                        </div>
                        <div class="form-group row">
