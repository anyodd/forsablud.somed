...
@section('title', 'Register Penerimaan')
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-6 text-right">
                                <form action="{{ route('regPiutangCetak') }}" target="_blank">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped" id="table-header" style="width: 100%">
                            <thead>
                                <tr>
                                    <th class="text-center" style="width: 3px; vertical-align: middle; font-size: 10pt">
                                        No</th>
                                    <th class="text-center" style="vertical-align: middle; font-size: 10pt">No. Bukti
                                    </th>
                                    <th class="text-center" style="vertical-align: middle; font-size: 10pt">Tgl. Bukti
                                    </th>
                                    <th class="text-center" style="vertical-align: middle; font-size: 10pt">No. Bukti
                                        Setor</th>
                                    <th class="text-center" style="vertical-align: middle; font-size: 10pt">Tgl. Setor
                                    </th>
                                    <th class="text-center" style="vertical-align: middle; font-size: 10pt">No. Rincian
                                    </th>
                                    <th class="text-center" style="vertical-align: middle; font-size: 10pt">Kode
                                        Rekening</th>
                                    <th class="text-center" style="vertical-align: middle; font-size: 10pt">Uraian
                                        Rekening</th>
                                    <th class="text-center" style="vertical-align: middle; font-size: 10pt">
                                        Jumlah<br>Piutang (Rp)</th>
                                    <th class="text-center" style="vertical-align: middle; font-size: 10pt">
                                        Jumlah<br>Dibayar (Rp)</th>
                                    <th class="text-center" style="vertical-align: middle; font-size: 10pt">Sisa (Rp)
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
