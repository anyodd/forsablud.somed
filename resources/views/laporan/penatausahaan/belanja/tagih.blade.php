            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <div>
                                <a href="{{ route('tagihan.pdf') }}" type="button" class="btn btn-outline-primary mb-2">
                                    <img src="{{ asset('template') }}/dist/img/icon_menu/laporan/laporan.png"
                                        alt="Product 1" class="nav-icon img-circle img-size-32 mr-1">
                                    Daftar Tagihan
                                </a>
                                <a href="{{ route('npd_pdf') }}" type="button" class="btn btn-outline-primary mb-2">
                                    <img src="{{ asset('template') }}/dist/img/icon_menu/laporan/laporan.png"
                                        alt="Product 1" class="nav-icon img-circle img-size-32 mr-1">
                                    NPD
                                </a>
                                <a href="" type="button" class="btn btn-outline-primary mb-2">
                                    <img src="{{ asset('template') }}/dist/img/icon_menu/laporan/laporan.png"
                                        alt="Product 1" class="nav-icon img-circle img-size-32 mr-1">
                                    Kontrak
                                </a>
                                ...
                                <a href="{{ route('pump_pdf') }}" type="button" class="btn btn-outline-primary mb-2">
                                    <img src="{{ asset('template') }}/dist/img/icon_menu/laporan/laporan.png"
                                        alt="Product 1" class="nav-icon img-circle img-size-32 mr-1">Panjar
                                </a>
                                <a href="{{ route('kump_pdf') }}" type="button" class="btn btn-outline-primary mb-2">
                                    <img src="{{ asset('template') }}/dist/img/icon_menu/laporan/laporan.png"
                                        alt="Product 1" class="nav-icon img-circle img-size-32 mr-1">Kuitansi
                                </a>
                                <a href="" type="button" class="btn btn-outline-primary mb-2">
                                    <img src="{{ asset('template') }}/dist/img/icon_menu/laporan/laporan.png"
                                        alt="Product 1" class="nav-icon img-circle img-size-32 mr-1">Pajak
                                </a>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="container py-4" style="background: white">
                                {{-- <div class="col-sm-1">
                                    <a href="javascript:cetak();"><button class="btn btn-primary"
                                            id="cetak">cetak</button></a>
                                </div> --}}
                                <h4 class="my-0" style="text-align: center"><b>{{ nm_unit() }}</b></h4>
                                <h4 class="my-0" style="text-align: center"><b>DAFTAR TAGIHAN /NOTA PENCAIRAN
                                        DANA</b></h4>
