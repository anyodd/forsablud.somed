  ...
  <div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col">
        ...
        <form action="{{ route('lapbb.index') }}" method="get" class="form-horizontal">
          @csrf

          <div class="card shadow-lg mt-2">
            <div class="card-header bg-info py-2">
              <h5 class="card-title font-weight-bold"> Buku Besar Rinci </h5> 
            </div>
                ...
                <table class="table table-sm table-bordered table-hover mb-0" id="example1" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center" style="width: 8%">{{ date('d M Y', strtotime($item->tgl_jr)) }}</td>
                      <td>{{ $item->uraian }}</td>
      ...
      processResults: function(data) {
        return {
          results: $.map(data, function(obj) {
            return {
              id: obj.Ko_RKK+'-'+obj.Ur_Rk6,
              text: obj.Ko_RKK+' - '+obj.Ur_Rk6
            };
          })
        };
      }
