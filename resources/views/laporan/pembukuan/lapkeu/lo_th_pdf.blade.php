    ...
    <thead>
      <tr class="text-center">
        <td>Pemerintah {{ nm_pemda() }} <br>
          ...
          Untuk Tahun yang Berakhir Sampai 31 Desember {{ Tahun () }} dan {{ Tahun()-1 }}
        </td>
      </tr>
  ...
  <table class="table table-sm table-bordered " id="" width="100%" cellspacing="0">
    ...
    <tbody>
      ...
      <tr class="text-right">
        ...
        <td>{{ number_format($lo_th_3->lo_kini, 2, ',', '.') }}</td>
        <td>{{ number_format($lo_th_3->lo_lalu, 2, ',', '.') }}</td>
        @if($lo_th_3->delta > 0)
      ...
      <tr class="text-right font-weight-bold">
        ...
        <td>{{ number_format($surplus_non_opr_kini, 2, ',', '.') }}</td>
        <td>{{ number_format($surplus_non_opr_lalu, 2, ',', '.') }}</td>
        ...
        <td>{{ number_format($delta_surplus_non_opr/$surplus_non_opr_lalu*100, 2, ',', '.') }}</td>
        @else
        <td>({{ number_format($delta_surplus_non_opr/$surplus_non_opr_lalu*100 * -1, 2, ',', '.') }})</td>
        @endif
      </tr>
      @else
      @endif
