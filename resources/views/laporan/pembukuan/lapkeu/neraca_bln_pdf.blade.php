    ...
    <body>
        ...
        <table class="table table-sm table-borderless " id="" width="100%" cellspacing="0">
            <thead>
                ...
                <tr>
                    <td class="text-right">(Dalam Rupiah)</td>
                </tr>
            </thead>
                    ...
                    @foreach ($neraca_aktiva as $number => $neraca_aktiva)
                        ...
                        @elseif(strlen($neraca_aktiva->kode) == 8 && substr($neraca_aktiva->kode, 6, 2) != '99')
                            <tr>
                                ...
                                @if ($neraca_aktiva->soakhir < 0)
                                    <td class="text-right">
                                        ({{ number_format($neraca_aktiva->soakhir * -1, 2, ',', '.') }})
                                    </td>
                                @else
                                    <td class="text-right">{{ number_format($neraca_aktiva->soakhir, 2, ',', '.') }}
                                    </td>
                                @endif

                                @if ($neraca_aktiva->soawal < 0)
                                    <td class="text-right">
                                        ({{ number_format($neraca_aktiva->soawal * -1, 2, ',', '.') }})</td>
                                @else
                                    <td class="text-right">{{ number_format($neraca_aktiva->soawal, 2, ',', '.') }}
                                    </td>
                                @endif
                            </tr>
                        ...
                        @elseif(substr($neraca_aktiva->kode, 3, 2) == '99')
                            <tr class="font-weight-bold">
                                ...
                                @if ($neraca_aktiva->soakhir < 0)
                                    <td class="text-right">
                                        ({{ number_format($neraca_aktiva->soakhir * -1, 2, ',', '.') }})</td>
                                @else
                                    <td class="text-right">{{ number_format($neraca_aktiva->soakhir, 2, ',', '.') }}
                                    </td>
                                @endif
            ...
            <tbody>
                    ...
                    @foreach ($neraca_pasiva as $number => $neraca_pasiva)
                        ...
                        @elseif(strlen($neraca_pasiva->kode) == 8 && substr($neraca_pasiva->kode, 6, 2) != '99')
                            <tr>
                                ...
                                @if ($neraca_pasiva->soakhir < 0)
                                    <td class="text-right">
                                        ({{ number_format($neraca_pasiva->soakhir * -1, 2, ',', '.') }})
                                    </td>
                                @else
                                    <td class="text-right">{{ number_format($neraca_pasiva->soakhir, 2, ',', '.') }}
                                    </td>
                                @endif

                                @if ($neraca_pasiva->soawal < 0)
                                    <td class="text-right">
                                        ({{ number_format($neraca_pasiva->soawal * -1, 2, ',', '.') }})</td>
                                @else
                                    <td class="text-right">{{ number_format($neraca_pasiva->soawal, 2, ',', '.') }}
                                    </td>
                                @endif
                            </tr>
                        ...
                        @elseif(substr($neraca_pasiva->kode, 3, 2) == '99')
                            <tr class="font-weight-bold">
                                ...
                                @if ($neraca_pasiva->soakhir < 0)
                                    <td class="text-right">
                                        ({{ number_format($neraca_pasiva->soakhir * -1, 2, ',', '.') }})</td>
                                @else
                                    <td class="text-right">{{ number_format($neraca_pasiva->soakhir, 2, ',', '.') }}
                                    </td>
                                @endif
                ...
                <tr class="font-weight-bold">
                    ...
                    @if ($jum_kewajiban_ekuitas_kini < 0)
                        <td class="text-right">({{ number_format($jum_kewajiban_ekuitas_kini * -1, 2, ',', '.') }})
                        </td>
                    @else
