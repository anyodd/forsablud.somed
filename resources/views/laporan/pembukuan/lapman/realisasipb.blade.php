                ...
                <div class="card card-info">
                    ...
                    @include('laporan.pembukuan.lapman.lapman_head')
                            ...
                            <thead>
                                <tr>
                                    <td class="text-center text-bold" colspan="12">
                                        LAPORAN REALIASAI BELANJA DAN PENDAPATAN <br>
                        ...
                        <table class="table table-bordered table-striped" id="table-header" style="width: 100%">
                            <thead>
                                <tr>
                                    <th rowspan="2" class="text-center" style="width: 3px; vertical-align: middle; font-size: 10pt">No</th>
                                    <th rowspan="2" class="text-center" style="vertical-align: middle; font-size: 10pt">Uraian</th>
                                    <th colspan="4" class="text-center" style="vertical-align: middle; font-size: 10pt">Jumlah(Rp)</th>
                                    <th colspan="2" class="text-center" style="vertical-align: middle; font-size: 10pt">Bertambah/(Berkurang)</th>
                                </tr>
                                <tr>
                                    <th class="text-center" style="vertical-align: middle; font-size: 10pt">Anggaran dalam DPA</th>
                                    <th class="text-center" style="vertical-align: middle; font-size: 10pt">Realisasi s/d...lalu</th>
                                    <th class="text-center" style="vertical-align: middle; font-size: 10pt">Realisasi...ini</th>
                                    <th class="text-center" style="vertical-align: middle; font-size: 10pt">Realisasi s/d...lalu</th>
                                    <th class="text-center" style="vertical-align: middle; font-size: 10pt">Rp</th>
                                    <th class="text-center" style="vertical-align: middle; font-size: 10pt">%</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
