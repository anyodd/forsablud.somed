                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <a href="{{ route('dbarinciPDF') }}" rel="noopener" target="_blank" type="button"
                                    ...
                                    @foreach ($gbrincirba as $gr => $rincirba)
                                        <tr>
                                            ...
                                            <td colspan="5" style="text-align: right"> <strong style="color: black">
                                                    {{ number_format($rincirba['subtotal']->To_Rp) }} </strong> </td>
                                        </tr>
