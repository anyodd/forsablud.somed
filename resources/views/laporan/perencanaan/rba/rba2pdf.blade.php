        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-body">
                    ...
                    <table class="table table-sm table-bordered" id="" width="100%" cellspacing="0" style="font-size: 8pt">
                        <thead class="">
                            <tr>
                                <td class="text-center" rowspan="2" style="vertical-align: middle;">No</td>
                                <td class="text-center" rowspan="2" style="vertical-align: middle;" colspan="4">Uraian
                                </td>
                                <td class="text-center" colspan="4">Pendapatan Layanan</td>
                                <td class="text-center" rowspan="2">APBD</td>
                                <td class="text-center" rowspan="2" colspan="4">Jumlah <br>(Rp)</td>
                            </tr>
                            <tr>
