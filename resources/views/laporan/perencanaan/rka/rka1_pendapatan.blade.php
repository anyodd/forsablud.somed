...
@section('content')
<div class="row">
  <a href="#" class="col-sm btn btn-info ml-3 py-1 disabled">RKA Pendapatan</a>
  ...
  <a href="{{ route('rka4_keluar_biaya') }}" class="col-sm btn btn-info ml-3 py-1">RKA Pengeluaran Pembiayaan</a>
</div>
...
<div class="card-body">
  <div class="row mb-2">
    ...
    <div class="col-sm">
      <a href="{{ route('rka1_pendapatan_pdf') }}" class="btn btn-sm btn-danger" target="_blank" style="float: right;">
        <i class="fas fa-file-pdf"></i> Cetak PDF
      </a>
    </div>
  </div>
  <div class="table-responsive">
    <table class="table table-sm table-bordered" id="" width="80%" cellspacing="0">
      <tbody>
        <tr>
        ...
        <tr>
          ...
          <td colspan="5">: 01.02 - Bidang Kesehatan</td>
        </tr>
        <tr>
          <td>Organisasi</td>
          <td colspan="5">: {{ kd_unit() }} - {{ nm_unit() }}</td>
        </tr>
        <tr>
          <td class="text-center" colspan="6">Rincian Anggaran Pendapatan Satuan Kerja Perangkat Daerah</td>
        </tr>
        <tr>
          <td class="text-center" rowspan="2" style="vertical-align: middle;">Kode Rekening</td>
          <td class="text-center" rowspan="2" style="vertical-align: middle;">Uraian</td>
          <td class="text-center" colspan="3">Rincian Perhitungan</td>
          <td class="text-center" rowspan="2">Jumlah <br>(Rp)</td>
        </tr>
        <tr>
          <td class="text-center">Volume</td>
          <td class="text-center">Satuan</td>
          <td class="text-center">Tarif/ <br>Harga</td>
        </tr>
        <tr>
          <td class="text-center" style="width: 17%;">1</td>
          ...
          <td class="text-center" style="width: 10%;">6 = (3x5)</td>
        </tr>
       ...
       @endif
        ...
        <tr>
          ...
          <td class="text-center" colspan="4" style="border-left-style: none;">
