<div class="modal fade" id="modalTambahSpd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea name="uraianSpd" class="form-control" id="uraianSpd" rows="3"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="nmPenandatanganSpd" class="col-sm-3 col-form-label">Nm. Penandatangan SPD</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" name="nmPenandatanganSpd" class="form-control" id="nmPenandatanganSpd">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="nipPenandatanganSpd" class="col-sm-3 col-form-label">NIP Penandatangan SPD</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" nama="nipPenandatanganSpd" class="form-control" id="nipPenandatanganSpd">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
