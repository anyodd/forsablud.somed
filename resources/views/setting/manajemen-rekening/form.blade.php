            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group row">
                        {!! Form::label('id_bidang', 'Urusan Bidang', ['class' => 'col-sm-4 col-form-label text-left font-weight-semibold border-bottom']) !!}
                        <div class="col-sm-8">
                            {!! Form::select('id_bidang', $model->idbidang ?? $idbidang, 0, [
