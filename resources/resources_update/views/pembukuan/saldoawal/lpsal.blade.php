...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid"><br>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="{{route('saldoawal.lpsal')}}" class="btn btn-sm btn-warning mb-2 disabled">Laporan Perubahan Saldo Anggaran Lebih</a>
                ...
                <div class="col-md-12">
                    <div class="card card-info mt-2">
                        <div class="card-header bg-info py-2">
                            <h5 class="card-title font-weight-bold">Saldo Awal Laporan Perubahan Saldo Anggaran Lebih</h5>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td class="text-left">{{ $item->ur_lpsal }}</td>
                                            <td class="text-right">{{ number_format($item->soaw_Rp,2,',','.') }}</td>
                                            <td class="text-center">
                                                <form
                                                    action="{{ route('saldoawal.delete_lpsal', $item->id_soawlp) }}"
        ...
        @include('pembukuan.saldoawal.create_lpsal')
