      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          ...
          <div class="card-body px-2 py-2">
            ...
            <form action="{{ route('setorpajak.store') }}" method="post" class="form-horizontal">
              @csrf
              @if(session('errors'))
              ...
              <div class="card-body">
                <div class="form-group row">
                  ...
                  <div class="col-sm">
                    <input type="text" name="No_bill" class="form-control @error('No_bill') is-invalid @enderror" value="{{ old('No_bill') }}" placeholder="Kode Billing">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="" class="col-sm-2 col-form-label">No. NTPN</label>
                  <div class="col-sm">
                    <input type="text" name="No_ntpn" class="form-control @error('No_ntpn') is-invalid @enderror" value="{{ old('No_ntpn') }}" placeholder="Nomor Transaksi Penerimaan Negara">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm">
                    <input type="date" name="dt_taxtor" class="form-control @error('dt_taxtor') is-invalid @enderror" value="{{ old('dt_taxtor') }}">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="" class="col-sm-2 col-form-label">Uraian</label>
                  <div class="col-sm">
                    <input type="text" name="Ur_taxtor" class="form-control @error('Ur_taxtor') is-invalid @enderror" value="{{ old('Ur_taxtor') }}" placeholder="Uraian">
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-sm">
                    <div class="input-group">
                      <input type="text" class="form-control @error('Ko_Rkk') is-invalid @enderror" id="Ko_Rkk" name="Ko_Rkk">
              ...
              <div class="form-group row justify-content-center mt-3">
                ...
                <a href="{{ route('setorpajak.show',$rekanan[0]->id_rekan) }}" class="col-sm-2 btn btn-danger ml-3">
