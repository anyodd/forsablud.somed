              ...
              <div class="card-body">
                <form action="{{ route('saldoawalpiutang.store') }}" method="POST">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="piut_doc" class="form-control">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-4">
                            <input type="date" name="dt_piut" class="form-control">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="piut_ur" class="form-control">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="piut_nm" class="form-control">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="piut_addr" class="form-control">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-2">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-4">
                            <input type="test" name="piut_Rp" class="form-control desimal">
                        </div>
                    </div>
