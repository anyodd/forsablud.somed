            ...
            <div class="col">
                <div class="card shadow-lg mt-2">
                    <div class="card-header bg-info py-2">
                        <h5 class="card-title font-weight-bold">Data SPP Panjar</h5>
                    </div>
                    <div class="card-body px-2 py-2">
                        <div class="row">
                            <div class="col-sm-12">
                                <a href="{{ route('spppanjar.create') }}">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <form action="{{ route('spppanjar-rinci.pilih', $row->id) }}"
                                                        method="get">
                                                ...
                                                <div class="col-sm-3">
                                                    <form action="{{ route('spppanjar.edit', $row->id) }}" method="get">
                                            ...
                                            <div class="modal fade" id="modal_verif{{ $row->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{route('spppanjar.verifikasi',$row->id)}}" method="post">
                                                        @csrf
                                            ...
                                            <div class="modal fade" id="modal{{ $row->id }}" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <form action="{{ route('spppanjar.destroy', $row->id) }}"
                                                                method="post" class="">
                                                                @csrf
                                                                @method('DELETE')
