      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          <div class="card-header bg-info py-2">
            <h5 class="card-title font-weight-bold">Edit SPP Nihil</h5> 
          </div>
          <div class="card-body px-2 py-2">
            <form action="{{ route('spjnihilupdate', $data->id) }}" method="post">
              @csrf
              @method("PUT")
              @if(session('errors'))
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="" class="col-form-label">:</label>
                            <div class="col-sm-5">
                                <input type="text" name="No_SPi" class="form-control @error('No_SPi') is-invalid @enderror" value="{{ old('No_SPi', $data->No_SPi) }}" placeholder="Nomor Bukti">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <label for="" class="col-form-label">:</label>
                            <div class="col-sm-5">
                                <input type="date" name="Dt_SPi" class="form-control @error('Dt_SPi') is-invalid @enderror" value="{{ old('Dt_SPi', $data->Dt_SPi->format('Y-m-d')) }}" placeholder="Tanggal Bukti">
                            </div>
                        </div>
                        <div class="form-group row">
              ...
              <div class="form-group row justify-content-center mt-3">
                ...
                <a href="{{ route('spjnihil.index') }}" class="col-sm-2 btn btn-danger ml-3">
