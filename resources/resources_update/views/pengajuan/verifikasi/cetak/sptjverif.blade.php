...
<body>
        ...
        <thead>
            ...
            <tr>
                <td class="text-center text-bold" colspan="12">
                    SURAT PERNYATAAN TANGGUNG JAWAB VERIFIKASI<br>
                    Nomor : 
                </td>
            </tr>
        </thead>
    ...
    <table class="table table-sm table-borderless" style="width: 100%">
        <tr>
            <td>Yang bertanda tangan dibawah ini PPK BLUD {{ nm_unit() }} <br>
                Menyatakan bahwa saya bertanggung jawab atas hasil verifikasi pertanggungjawaban belanja sebagaimana terlampir dalam ringkasan sebagai berikut : <br>
            </td>
        </tr>
    </table>
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td colspan="4" style="text-align: center">
                Pejabat Penatausahaan Keuangan<br>
                <br><br><br>
                {{$data->Nm_Keu}}<br>
                NIP {{$data->NIP_Keu}}
                <br><br><br>
