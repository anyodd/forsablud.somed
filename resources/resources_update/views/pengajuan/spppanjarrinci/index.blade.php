            ...
            <div class="col">
                <div class="card shadow-lg mt-2">
                    <div class="card-header bg-info py-2">
                        <h5 class="card-title font-weight-bold">Data Rincian SPP Panjar</h5>
                    </div>
                    <div class="card-body px-2 py-2">
                        <div class="row">
                            <div class="col-sm-12">
                                <a href="{{ route('spppanjar-rinci.tambah', $spppanjar[0]->id) }}">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-bordered table-hover mb-0" id="example" width="100%"
                                ...
                                <tbody>
                                    <?php $no = 0;?>
                                    @foreach($spppanjar_rinci as $row)
                                    <?php $no++ ;?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <form action="{{ route('spppanjar-rinci.edit', $row->id) }}"
                                                        method="get">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <form
                                                                action="{{ route('spppanjar-rinci.destroy', $row->id) }}"
                                                                method="post" class="">
                                                                @csrf
                                                                @method('DELETE')
