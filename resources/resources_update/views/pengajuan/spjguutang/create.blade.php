      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          <div class="card-header bg-info py-2">
            <h5 class="card-title font-weight-bold">Tambah SPP Ganti Uang (GU)</h5> 
          </div>
          <div class="card-body px-2 py-2">
            <form action="{{ route('spjguutang.store') }}" method="post">
              @csrf
              @if(session('errors'))
            ...
            <div class="card-body">
              ...
              <div class="form-group row justify-content-center mt-3">
                ...
                <a href="{{ route('spjgu.index') }}" class="col-sm-2 btn btn-danger ml-3">
