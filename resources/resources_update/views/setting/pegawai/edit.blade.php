      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          <div class="card-header bg-info py-2">
            <h5 class="card-title font-weight-bold">Edit Data Pegawai</h5> 
          </div>

          <div class="card-body px-2 py-2">

            <form action="{{ route('pegawai.update', $pegawai->id_pjb) }}" method="post" class="form-horizontal">
              @csrf
              @method("PUT")
              @if(session('errors'))
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm">
                    <input type="text" name="Nm_pjb" class="form-control @error('Nm_pjb') is-invalid @enderror" value="{{ old('Nm_pjb', $pegawai->Nm_pjb) }}" placeholder="Nama">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="" class="col-sm-2 col-form-label">NIP</label>
                  <div class="col-sm-4">
                    <input type="text" name="NIP_pjb" maxlength="21" class="form-control @error('NIP_pjb') is-invalid @enderror" value="{{ old('NIP_pjb', $pegawai->NIP_pjb) }}" placeholder="NIP tanpa spasi" readonly>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-sm">
                    <select name="id_pj" class="form-control select2 @error('id_pj') is-invalid @enderror">
                      ...
                      @if (old('id_pj', $pegawai->id_pj) == $jabatan->id_pj)
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm">
                    <select name="kd_bidang" class="form-control select2 @error('kd_bidang') is-invalid @enderror">
                      ...
                      @if (old('kd_bidang', $pegawai->Ko_unit1) == $bidang->ko_unit1)
