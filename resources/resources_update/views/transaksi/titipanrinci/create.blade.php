                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form action="{{ route('titipanrinci.store') }}" method="POST" >
                                    @csrf
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="number"  name="Ko_bprc" id="Ko_bprc" value="{{$max+1}}" class="form-control" readonly>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-md-2">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" placeholder=" Isikan NIK pihak penitip" name="rftr_bprc" id="rftr_bprc" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-10">
                                                <input type="date"  placeholder="Tanggal penitipan" name="dt_rftrbprc" id="dt_rftrbprc" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-md-2">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-10">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control desimal" id="To_Rp" name="To_Rp"  placeholder="Nilai pembiayaan">
                                                    </div>
                                            </div>
                                        </div>
                                        <div class="row form-group">
