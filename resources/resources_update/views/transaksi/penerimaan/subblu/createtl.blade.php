      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          <div class="card-header bg-info py-2">
            <h5 class="card-title font-weight-bold">Tambah Data Penerimaan Tahun Lalu</h5> 
          </div>
          <form action="{{ route('subpenerimaan.store') }}" method="post" class="form-horizontal">
          @csrf
          <div class="card-body px-2 py-2">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                    <input type="text" name="To_RR" class="form-control desimal" id="To_Rp_3">
                </div> 
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                      <input type="text" name="Ur_bprc" class="form-control @error('Ur_bprc') is-invalid @enderror" id="Ur_bprc">
                  </div> 
              </div>
              <div class="form-group row">
                  <label for="rftr_bprc" class="col-sm-3 col-form-label">Nomor Referensi</label>
                  <div class="col-sm-9">
                      <input type="text" name="rftr_bprc" class="form-control @error('rftr_bprc') is-invalid @enderror" id="rftr_bprc">
                  </div> 
              </div>
              <div class="form-group row">
                  <label for="dt_rftrbprc" class="col-sm-3 col-form-label">Tanggal Referensi</label>
                  <div class="col-sm-2">
                      <input type="date" name="dt_rftrbprc" class="form-control @error('dt_rftrbprc') is-invalid @enderror" id="dt_rftrbprc" value="{{ date( Tahun().'-m-d') }}" min="{{ Tahun().'-01-01' }}" max="{{ Tahun().'-12-31' }}">
                  </div> 
              </div>
              <div class="form-group row">
                  <label for="To_Rp" class="col-sm-3 col-form-label">Nilai (Rp)</label>
                  <div class="col-sm-2">
                      <input type="text" name="To_Rp" class="form-control desimal @error('To_Rp') is-invalid @enderror" id="To_Rp2">
                  </div>
              </div>
              <div class="form-group row">
...
@include('transaksi.penerimaan.subblu.popup.piutang')
@endsection
