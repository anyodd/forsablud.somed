          ...
          <div class="card-body px-2 py-2">
              ...
              <div class="card-body"> 
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-1">
                    <a href="{{route('realisasitl.bulan',Session::get('bulan'))}}" class="btn btn-sm btn-info" id="kembali">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                  <form action="{{ route('realisasitl.destroy', $item->id_byr) }}" method="post" class="">
                                    @csrf
                                    @method('DELETE')
...
@include('transaksi.penerimaan.realisasi.tl.popup.list_piutang')
...
<script>
  ...
  $(document).on('click','#bayar', function () {
    ...
    if (rp == '') {
      ...
      $.ajax({
        url: "{{ route('realisasitl.store_rinci') }}",
        type: 'POST',
        data: data,
        dataType: 'JSON',
