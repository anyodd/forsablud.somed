...
@section('title', 'Realisasi Penerimaan Diterima Dimuka')
@section('style') 
  ...
  <div class="container-fluid"><br>
    <div class="row">
      <div class="col-md-12">
          ...
          <a href="#" class="btn btn-sm btn-primary disabled">Pendapatan Diterima Dimuka</a>
      </div>
  </div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <a href= "{{ route('realisasipdd.tambah',$realisasi->id_bp) }}" class="btn btn-sm btn-success" title="Realisasi" onclick="deleteItems()">
...
<script>
  ...
  function Mymonth()
  {
    var slug = $('#bulan').val();
    console.log(slug);
    var url = '{{ route("realisasipdd.bulan", ":slug") }}';
