      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          <div class="card-header bg-info py-2">
            <h5 class="card-title font-weight-bold">Edit Data Rincian Tagihan</h5> 
          </div>

          <div class="card-body px-2 py-2">

            <form action="{{ route('subtagihan.update', $data->id_bprc) }}" method="post" class="form-horizontal">
              @csrf
              @method("PUT")
              @if(session('errors'))
              ...
              <div class="card-body">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-2">
                          <input type="text" name="To_Rp1" class="form-control text-right" id="To_Rp" value="{{old('To_Rp1', number_format($data->To_Rp,2,',','.'))}}" readonly>
                      </div> 
                      <div class="col-sm-2">
                          {{-- <input type="text" name="" class="form-control text-right" id="sKo_Pdp" value="{{old('Ko_Pdp')}}" hidden readonly> --}}
                      </div> 
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                          <input type="text" name="Ur_bprc" class="form-control" value="{{old('Ur_bprc', $data->Ur_bprc)}}" id="Ur_bprc">
                      </div> 
                  </div>
                  <div class="form-group row">
                      <label for="rftr_bprc" class="col-sm-3 col-form-label">Nomor Referensi</label>
                      <div class="col-sm-9">
                          <input type="text" name="rftr_bprc" class="form-control" value="{{old('rftr_bprc', $data->rftr_bprc)}}" id="rftr_bprc">
                      </div> 
                  </div>
                  <div class="form-group row">
                      <label for="dt_rftrbprc" class="col-sm-3 col-form-label">Tanggal Referensi</label>
                      <div class="col-sm-9">
                          <input type="date" name="dt_rftrbprc" class="form-control" id="dt_rftrbprc" value="{{old('dt_rftrbprc', $data->dt_rftrbprc)}}" min="{{ Tahun().'-01-01' }}" max="{{ Tahun().'-12-31' }}">
                      </div> 
                  </div>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                          <input type="text" name="To_Rp" value="{{old('To_Rp', number_format($data->To_Rp,2,',','.'))}}" class="form-control desimal" id="To_Rp">
                      </div>
                  </div>
                  <div class="form-group row">
