      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          <div class="card-header bg-info py-2">
            <h5 class="card-title font-weight-bold">Tambah Rincian Kuitansi</h5> 
          </div>

          <div class="card-body px-2 py-2">

            <form action="{{ route('subkuitansi.store') }}" method="post" class="form-horizontal">
              @csrf
              @if(session('errors'))
              ...
              <div class="card-body">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-2">
                          <input type="text" name="To_Rp" class="form-control text-right" id="To_Rp" value="{{ old('To_Rp') }}" readonly>
                      </div> 
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                          <input type="text" name="Ur_bprc" class="form-control" id="Ur_bprc" value="{{ old('Ur_bprc') }}">
                      </div> 
                  </div>
                  <div class="form-group row">
                      <label for="rftr_bprc" class="col-sm-3 col-form-label">Nomor Kuitansi</label>
                      <div class="col-sm-9">
                          <input type="text" name="rftr_bprc" class="form-control" id="rftr_bprc" value="{{ old('rftr_bprc') }}">
                      </div> 
                  </div>
                  <div class="form-group row">
                      <label for="dt_rftrbprc" class="col-sm-3 col-form-label">Tanggal Kuitansi</label>
                      <div class="col-sm-9">
                          <input type="date" name="dt_rftrbprc" class="form-control" id="dt_rftrbprc" value="{{ date( Tahun().'-m-d') }}" min="{{ Tahun().'-01-01' }}" max="{{ Tahun().'-12-31' }}">
                      </div> 
                  </div>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                          <input type="number" name="To_Rp" class="form-control" id="To_Rp" value="{{ old('To_Rp') }}">
                      </div>
                  </div>
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                          <select id="Ko_kas" name="Ko_kas" class="form-control select2 select2-danger @error('Ko_kas') is-invalid @enderror" data-dropdown-css-class="select2-danger" style="width: 100%;" autofocus>
                              ...
                              <option value="2" selected>Tunai Fisik</option>
                          </select>
                          @error('Ko_kas')
              ...
              <div class="form-group row justify-content-center mt-3">
                ...
                <a href="{{ route('subkuitansi.rincian', $data->id_bp) }}" class="col-sm-2 btn btn-danger ml-3">
