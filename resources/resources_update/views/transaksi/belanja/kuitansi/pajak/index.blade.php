      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          ...
          <div class="card-body px-2 py-2">
              ...
              <table class="table-borderless table-sm text-nowrap">
                <tbody>
                  <tr>
                    ...
                    <td>{{$kuitansi->No_bp}}</td>
                  </tr>
                  <tr>
                    <td style="width: 10px"><b>Uraian</b></td>
                    <td style="width: 1px">:</td>
                    <td>{{$kuitansi->Ur_bp}}</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <a href="{{route('subkuitansi.rincian',$kuitansi->id_bp)}}" class="btn btn-info btn-sm mb-2"><i class="fas fa-reply"></i> Kembali</a>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              <form action="{{route('tagihan.destroyPajak',$pajak->id_tax)}}" method="post" class="">
                                @csrf
                                @method('DELETE')
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="card card-info">
                                                ...
                                                <!-- /.card-header -->
                                                <div class="card-body">
                                                    <form action="{{route('tagihan.editpotongpajak',$pajak->id_tax)}}" method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="row form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="input-group input-group-sm">
                                                                    <input type="text" class="form-control" name="id_bp" value="{{$kuitansi->id_bp}}" readonly>
                                                                    <input type="text" class="form-control" name="No_bp" value="{{$kuitansi->No_bp}}" readonly>
                                                                    <input type="text" class="form-control" name="Ur_bp" value="{{$kuitansi->Ur_bp}}" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="input-group input-group-sm">
                                                                    <input type="text" class="form-control" name="Ko_Period" value="{{$kuitansi->Ko_Period}}" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="input-group input-group-sm">
                                                                    <input type="text" class="form-control" name="Ko_unit1" value="{{$kuitansi->Ko_unit1}}" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="input-group input-group-sm">
                                                                    <input type="text" class="form-control" name="Ko_bp" value="{{$kuitansi->Ko_bp}}" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-info">
                                            ...
                                            <!-- /.card-header -->
                                            <div class="card-body">
                                                <form action="{{route('tagihan.potongpajak')}}" method="POST">
                                                    @csrf
                                                    <div class="row form-group">
                                                        <div class="col-md-2">
                                                            <label for="No_byr">Kode/No/Uraian BP</label>
...
@include('transaksi.belanja.tagihan.pajak.popup.rekening')
@endsection
