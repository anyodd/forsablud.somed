...
<script>
  $(document).ready(function() {
    $('#KoPdp').change( function(){
        var koPdp = $(this).val();
        if(koPdp==1){
            $('#param2').html("<option value='1'>Umum</option> <option value='2'>BPJS</option> <option value='3'>Asuransi</option>");
        }else if(koPdp==2){
            $('#param2').html("<option value='4'>APBN</option> <option value='5'>APBN</option> <option value='6'>CSR</option>");
        }else if(koPdp==3){
            $('#param2').html("<option value='7'>KSO</option> <option value='8'>KSP</option> <option value='9'>Sewa</option>");
        }else if(koPdp==4){
            $('#param2').html("<option value='5'>APBD</option>");
        }else if(koPdp==5){
            $('#param2').html("<option value='10'>Jasa</option> <option value='11'>Bunga</option> <option value='12'>Lainnya</option>");
        }
    });
  })
</script>
