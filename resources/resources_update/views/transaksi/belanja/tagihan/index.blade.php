...
@section('content')
    <section class="content px-0">
        <div class="container-fluid"><br>
            <div class="row">
                <div class="col-md-12">
                    <a href="{{route('tagihan.bulan',Session::get('bulan'))}}" class="btn btn-primary disabled">Tahun Berjalan</a>
                    {{-- <a href="{{route('tagihanlalu.bulan',Session::get('bulan'))}}" class="btn btn-primary">Tahun Lalu</a> --}}
                    <a href="{{route('tagihanlalu.index')}}" class="btn btn-primary">Tahun Lalu</a>
                </div>
              </div>
                ...
                <div class="col">
                    <div class="card shadow-lg mt-2">
                        <div class="card-header bg-info py-2">
                            <h5 class="card-title font-weight-bold">Data Belanja : Tagihan</h5>
                        </div>
                                        ...
                                        @foreach ($data as $number => $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row justify-content-center">
                                                        <div class="col-sm-3">
                                                            <a href="{{ route('subtagihan.rincian',$data->id_bp) }}">
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form
                                                                        action="{{ route('tagihan.destroy', $data->id_bp) }}"
                                                                        method="post" class="">
                                                                        @csrf
                                                                        @method('DELETE')
...
@section('script')
    <script>
        ...
        function Mymonth()
        {
            var slug = $('#bulan').val();
            console.log(slug);
            var url = '{{ route("tagihan.bulan", ":slug") }}';
