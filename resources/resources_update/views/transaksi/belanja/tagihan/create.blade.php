      ...
      <div class="col">
        <div class="card shadow-lg mt-2">
          ...
          <div class="card-body px-2 py-2">
            ...
            <form action="{{ route('tagihan.store') }}" method="post" class="form-horizontal">
              @csrf
              @if(session('errors'))
              ...
              <div class="card-body">
                <div class="form-group row">
                  ...
                  <div class="col-sm">
                    <input type="text" name="No_bp" class="form-control @error('No_bp') is-invalid @enderror" value="{{old('No_bp')}}" placeholder="Masukan Nomor Dokumen">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm">
                    <input type="date" name="DtJt" class="form-control @error('DtJt') is-invalid @enderror" value="{{ date( Tahun().'-m-d') }}" min="{{ Tahun().'-01-01' }}" max="{{ Tahun().'-12-31' }}" >
                  </div>
                </div>
                <div class="form-group row">
                  <label for="" class="col-sm-2 col-form-label">Uraian</label>
                  <div class="col-sm">
                    <input type="text" name="UrBp" class="form-control @error('UrBp') is-invalid @enderror" value="{{old('UrBp')}}" placeholder="Keterangan Transaksi">
                  </div>
                </div>
                <div class="form-group row">
              ...
              <div class="form-group row justify-content-center mt-3">
                ...
                {{-- <a href="{{ route('tagihan.index') }}" class="col-sm-2 btn btn-danger ml-3"> --}}
