...
@section('title', 'Register Kontrak')
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-6 text-right">
                                <form action="{{ route('reg.kontrak.cetak') }}" target="_blank">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table" style="width: 100%">
                            ...
                            <table class="table table-bordered table-striped" id="table-header" style="width: 100">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="text-center" id='baris-kosong' colspan=10>Silahkan Pilih Periode
                                            Pelaporan</td>
                                        <td class="text-center" id='baris-loader' colspan=10>
