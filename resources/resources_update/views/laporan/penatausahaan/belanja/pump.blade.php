                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="container py-4" style="background: white">
                                ...
                                <h4 class="my-0" style="text-align: center"><b>PERMINTAAN UANG PANJAR</b></h4>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table-sm" width="100%">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td style="padding-top: 0; padding-bottom: 0; width: 20%">Sub
                                                            Kegiatan</td>
                                                        <td style="padding-top: 0; padding-bottom: 0; width: 2%">:</td>
                                                        <td style="padding-top: 0; padding-bottom: 0; width: 78%"
                                                            id="kegiatan"></td>
                                                    ...
                                                    <tr>
                                                        <td style="padding-top: 0; padding-bottom: 0; width: 20%">Anggaran
                                                            Tersedia</td>
                                                        <td style="padding-top: 0; padding-bottom: 0; width: 2%">:</td>
                                                        <td style="padding-top: 0; padding-bottom: 0; width: 78%">Rp </td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <table class="table table-sm table-bordered" width="100%" id="pumpTable">
                                                <thead>
                                                    <tr>
                                                        <th rowspan="2"
                                            ...
                                            <table class="table-sm" width="100%">
                                                <tbody>
                                                    <tr>
                                                        <td style="text-align: middle; padding-top: 0; padding-bottom: 0">
                                                            Setuju di berikan uang muka/panjar<br>
                                                            <p id="sebesar">sebesar Rp ......</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td
                                                            ...
                                                            <br>Pimpinan BLUD,
                                                            <br><br><br>{{ tb_sub('Nm_Pimp') }}<br>NIP.
                                                            {{ tb_sub('Nip_Pimp') }}
                                                        </td>
                                                        </td>
...
@section('script')
    <script>
            ...
            $('#pilih').change(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        console.log(data);
                        var kegiatan = data['kegiatan'][0]['Ur_KegBL2'];
        ...
        function cetak() {
            ...
            window.open('pump/print_pump/' + id, '_blank');
