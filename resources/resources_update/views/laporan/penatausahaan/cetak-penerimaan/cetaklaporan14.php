...
$pdf->SetXY(35, $pdf->getY() + 2);
$pdf->MultiCell(150, 4, 'BUKU PEMBANTU KAS BANK', '', 'C', 0);
$pdf->SetXY(35, $pdf->getY() + 2);
...
foreach ($model['data']['bkupdptbank'] as $data) {
...
$pdf->MultiCell(150, 5, 'Saldo Kas di Bendahara Penerimaan/Bendahara Penerimaan Pembantu Bank adalah Rp ' . number_format($totalsaldo, 2, ',', '.'), '', 'L', 0);
$pdf->SetXY($x, $pdf->GetY());
