                            ...
                            <table class="table table-bordered table-striped" style="width: 100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2" class="text-center">Jumlah Anggaran</th>
                                        <th colspan="3" class="text-center">SPJ LS Gaji</th>
                                        <th colspan="3" class="text-center">SPJ LS Barang dan Jasa</th>
                                        <th colspan="3" class="text-center">SPJ UP/GU/TU</th>
                                        <th rowspan="2" class="text-center">Jumlah SPJ (LS+UP/GU/TU) s.d Bulan ini</th>
                                        <th rowspan="2" class="text-center">Sisa Pagu Anggaran</th>
                                    </tr>
                                    <tr>
