...
@section('title', 'Laporan Penerimaan dan Penyetoran')
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-6 text-right">
                                    <form action="{{ route('penerimaan_lpp_cetak') }}" target="_blank">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered table-striped" id="table-header" style="width: 100%;font-size: 10pt">
                                <thead>
                                    <tr>
