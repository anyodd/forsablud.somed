...
@section('title', 'Laporan Pertanggungjawaban Bendahara Penerimaan')
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-6 text-right">
                                <form action="{{route('fungsionalpenerimaan_cetak')}}" method="post" target="_blank">
                                    @csrf
                                    @method('POST')
...
<script>
        ...
        $(function() {
            ...
            $('#bulan').change(function () { 
                ...
                $.ajax({
                    type: "post",
                    url: "{{ route('fungsionalpenerimaan_isi') }}",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        "bulan": bulan
                    },
