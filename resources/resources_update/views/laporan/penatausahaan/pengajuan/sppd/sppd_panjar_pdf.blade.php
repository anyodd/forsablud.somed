    ...
    <tbody>
      <tr>
        <td class="font-weight-bold text-center">
          ...
          SURAT PERMINTAAN PENCAIRAN DANA PANJAR<br>
          (SURAT-PPD PANJAR)<br>
          NOMOR {{ $spi->No_SPi }}
        </td>
      </tr>
  ...
  <table class="table table-sm table-bordered" id="" width="100%" cellspacing="0">
    <tbody>
      ...
      <tr class="text-center">
        <td class="font-weight-bold" colspan="6">Ringkasan DBA/DBAP (16)</td>
      </tr>
      <tr class="text-center">
        <td colspan="4">Jumlah Dana DBA/DBAP</td>
    ...
    <tbody>
      <tr>
        ...
        <td style="width: 70%">
          ...
          : {{ $qr_spp[0]->rekan_nmbank ?? "--" }} / {{ $qr_spp[0]->rekan_rekbank ?? "--" }}
        </td>
      </tr>
    </tbody>
  </table>
