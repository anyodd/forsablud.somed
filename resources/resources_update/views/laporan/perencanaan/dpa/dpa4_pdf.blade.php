...
<body>
    ...
    <table class="table table-sm table-bordered" id="a" width="100%" cellspacing="0">
      <tbody>
        ...
        @foreach($ambildatapdfdpa4 as $number => $ambildatapdfdpa4)
        <tr>
          <!-- Baris 10 -->
          <td class="text-center" colspan="3">{{ $ambildatapdfdpa4->Ko_Rkk}}</td>
          <td colspan="3">{{ $ambildatapdfdpa4->Ur_Rk6}}</td>
          <td class="text-right" colspan="3">{{ number_format($ambildatapdfdpa4->To_Rp, 0, ",", ".") }}</td>
        </tr>
        @endforeach
        <tr>
          <!-- Baris 11 -->
        ...
        <tr>
          ...
          <td class="text-center" id="hapus" colspan="4" rowspan="2">
            {{ $ambildatapdfdpa4->nm_pimp = '' ? $ambildatapdfdpa4->nm_pimp : '-'}}<br>
            NIP. {{ $ambildatapdfdpa4->nip_pimp = '' ? $ambildatapdfdpa4->nm_pimp : '-'}}
          </td>
        </tr>
        <tr>
          <!-- Baris 20 -->
