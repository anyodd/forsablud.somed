...
<body>
    ...
    <table class="table table-sm table-bordered" id="a" width="100%" cellspacing="0">
      <tbody>
        ...
        @foreach($ambildatapdfdpa3 as $number => $ambildatapdfdpa3)
        <tr>
          <!-- Baris 10 -->
          <td class="text-center" colspan="3">{{ $ambildatapdfdpa3->Ko_Rkk}}</td>
          <td colspan="3">{{ $ambildatapdfdpa3->Ur_Rk6}}</td>
          <td class="text-right" colspan="3">{{ number_format($ambildatapdfdpa3->To_Rp, 0, ",", ".") }}</td>
        </tr>
        @endforeach
        <tr>
          <!-- Baris 13 -->
      ...
      <tr>
        ...
        <td class="text-center" id="hapus" colspan="4" rowspan="2">
          {{ $ambildatapdfdpa3->nm_pimp = '' ? $ambildatapdfdpa3->nm_pimp : '-'}}<br>
          NIP. {{ $ambildatapdfdpa3->nip_pimp = '' ? $ambildatapdfdpa3->nip_pimp : '-'}}
        </td>
      </tr>
      <tr>
        <!-- Baris 20 -->
