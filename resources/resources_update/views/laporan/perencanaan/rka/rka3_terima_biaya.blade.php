...
<div class="row">
  ...
  <a href="#" class="col-sm btn btn-info ml-3 py-1 disabled">RKA Penerimaan Pembiayaan</a>
...
<div class="card-body">
  <div class="row mb-2">
    ...
    <div class="col-sm">
      <a href="{{ route('rka3_terima_biaya_pdf') }}" class="btn btn-sm btn-danger" target="_blank" style="float: right;">
