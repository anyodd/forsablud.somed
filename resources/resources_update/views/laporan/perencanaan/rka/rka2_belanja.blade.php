...
<div class="row">
  ...
  <a href="#" class="col-sm btn btn-info ml-3 py-1 disabled">RKA Belanja</a>
...
<div class="card-body">
  <div class="row mb-2">
    ...
    <div class="col-sm">
      <a href="{{ route('rka2_belanja_pdf') }}" class="btn btn-sm btn-danger" target="_blank" style="float: right;">
  ...
  <div class="table-responsive">
    <table class="table table-sm table-bordered" id="" width="100%" cellspacing="0">
      <tbody>
        ...
        <tr>
          <td>Program</td>
          <td colspan="2">: 01 - PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH KABUPATEN/KOTA</td>
        </tr>
        <tr>
          <td>Kegiatan</td>
          <td colspan="2">: 01.2.10 - Peningkatan Pelayanan BLUD</td>
        </tr>
        <tr>
          <td>Lokasi Kegiatan</td>
          <td colspan="2">: {{ nm_ibukota() }}</td>
        </tr>
        <tr>
          <td>Jumlah Tahun n-1</td>
          <td colspan="2">: Rp .......... (........) ..... (8)</td>
        </tr>
        <tr>
          <td>Jumlah Tahun n</td>
          <td colspan="2">: Rp .......... (........) ..... (9)</td>
        </tr>
        <tr>
          <td>Jumlah Tahun n+1</td>
          <td colspan="2">: Rp .......... (........) ..... (10)</td>
        </tr>
        <tr>
          <td class="text-center" colspan="3">Indikator & Tolak Ukur Kinerja Belanja Langsung ... (11)</td>
        </tr>
        <tr class="text-center">
          <td>Indikator</td>
          <td>Tolok Ukur Kinerja</td>
        ...
        <tr>
          <td colspan="3">Kelompok Sasaran Kegiatan : ................... (12)</td>
        </tr>
        <tr>
          <td class="text-center" colspan="3">
            Rincian Anggaran Belanja Langsung <br>
