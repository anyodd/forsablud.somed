                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <a href="{{ route('dbapembiayaanPDF') }}" rel="noopener" target="_blank" type="button"
                                        ...
                                        @foreach ($urpdp['rincian'] as $item)
                                            <tr>
                                                ...
                                                <td colspan="5" style="text-align: right">
                                                    {{ number_format($item->sumtotal) }}</td>
                                            </tr>
                                        @endforeach
                                    @endforeach
                                    <tr>
                                        ...
                                        <td colspan="5" style="text-align: right"> <strong
                                                style="color: blue">{{ number_format($total) }} </strong> </td>
                                    </tr>
                                </tbody>
                                {{-- alternatif 3 --}}
                                <tfoot>
