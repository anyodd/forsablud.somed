                    ...
                    <table id="example1" class="table table-sm table-bordered table-striped" style="width: 100%">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="width:4px" colspan="3">2</td>
                        ...
                        <tbody>
                            @foreach ($gbringrba as $gr => $urrba)
                                <tr>
                                    ...
                                    <td colspan="6"><strong> {{ $gr }} </strong></td>
                                    <td colspan="5" style="text-align: right"> 
                                        <strong>{{ number_format($urrba['subtotal']->To_Rp,2,',','.') }}</strong>
                                    </td>
                                </tr>
                                @foreach ($urrba['rincian'] as $item)
                                    <tr>
                                        <td style="text-align: left"></td>
                                        <td style="text-align: center">{{ $item->Ko_Rk2 }}</td>
                                        <td style="text-align: left" colspan="5">{{ $item->Ur_Rk3 }}</td>
                                        <td style="text-align: right" colspan="5">{{ number_format($item->To_Rp,2,',','.') }}</td>
                                    </tr>
                                @endforeach
                            @endforeach
                        </tbody>
