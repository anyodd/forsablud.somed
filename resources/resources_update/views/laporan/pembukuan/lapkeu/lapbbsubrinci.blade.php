  ...
  <div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col">
        ...
        <form action="{{ route('lapbb_subrinci') }}" method="get" class="form-horizontal">
          @csrf

          <div class="card shadow-lg mt-2">
            <div class="card-header bg-info py-2">
              <h5 class="card-title font-weight-bold">Buku Besar Sub Rinci 2</h5> 
            </div>
                ...
                <table class="table table-sm table-bordered table-hover mb-0" id="example1" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $item->ur_rkk }}</td>
                      <td class="text-center">{{ \Carbon\Carbon::parse($item->tgl_jr)->format('d/m/Y') }}</td>
      ...
      processResults: function(data) {
        ...
        return {
          results: $.map(data, function(obj) {
            return {
              id: obj.Ko_RKK+'-'+obj.Ur_Rk5,
              text: obj.Ko_RKK+' - '+obj.Ur_Rk5
            };
          })
        };
      }
