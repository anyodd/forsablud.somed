...
$y1 = $pdf->GetY(); //berikan nilai untuk $y1 titik terbawah Uraian Kegiatan
$pdf->SetXY($xcurrent, $y);
$pdf->MultiCell($w[1], 5, $pdf->accountingNumberFormat($model['data']['saldoKasRkud']->saldo_sa), '', 'R');
$xcurrent = $xcurrent + $w[1];
$y2 = $pdf->GetY(); //berikan nilai untuk $y1 titik terbawah Uraian Kegiatan
$pdf->SetXY($xcurrent, $y);
$pdf->MultiCell($w[2], 5,  $pdf->accountingNumberFormat($model['data']['saldoKasRkud']->saldo_sa - $totalArusKasAwal), '', 'R');
$xcurrent = $xcurrent + $w[2];
$y3 = $pdf->GetY(); //berikan nilai untuk $y1 titik terbawah Uraian Kegiatan
$pdf->SetXY($xcurrent, $y);
...
$y1 = $pdf->GetY(); //berikan nilai untuk $y1 titik terbawah Uraian Kegiatan
$pdf->SetXY($xcurrent, $y);
$pdf->MultiCell($w[1], 5, $pdf->accountingNumberFormat($model['data']['saldoKasRkud']->saldo), '', 'R');
$xcurrent = $xcurrent + $w[1];
$y2 = $pdf->GetY(); //berikan nilai untuk $y1 titik terbawah Uraian Kegiatan
$pdf->SetXY($xcurrent, $y);
$pdf->MultiCell($w[2], 5,  $pdf->accountingNumberFormat($model['data']['saldoKasRkud']->saldo_sa), '', 'R');
$xcurrent = $xcurrent + $w[2];
$y3 = $pdf->GetY(); //berikan nilai untuk $y1 titik terbawah Uraian Kegiatan
$pdf->SetXY($xcurrent, $y);
