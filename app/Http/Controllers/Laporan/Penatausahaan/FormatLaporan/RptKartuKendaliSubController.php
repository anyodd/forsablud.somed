...
class RptKartuKendaliSubController extends Controller
{
		...
		if($apbd[0]->apbd == 0){
			$rincianSubkegiatan = DB::select("WITH anggaran AS (								
									...
									spj_ini_gu AS (
										...
										FROM
										(
											SELECT A.Ko_Period, A.Ko_sKeg1, A.Ko_sKeg2, A.ko_rkk, SUM(A.spirc_Rp) AS nilai
									...
									ls_ini AS(
										...
										SELECT A.Ko_Period, A.Ko_sKeg1, A.Ko_sKeg2, A.ko_rkk, SUM(A.spirc_Rp) AS nilai
												...
												GROUP BY A.Ko_Period, A.Ko_sKeg1, A.Ko_sKeg2, A.ko_rkk
										UNION ALL
										SELECT A.Ko_Period, A.Ko_sKeg1, A.Ko_sKeg2, map.Ko_RKK, SUM(A.spirc_Rp) AS nilai
												FROM tb_spirc A INNER JOIN
												tb_spi B ON A.id_spi = B.id INNER JOIN
												tb_oto C ON B.id = C.id_spi INNER JOIN
												tb_npd D ON C.id = D.id_oto INNER JOIN
									...
									SELECT  a.kdprogram, a.kdkegiatan, a.kdsubkegiatan, a.nmprogram, a.nmkegiatan, a.nmsubkegiatan, a.kdrek1, a.kdrek2, a.kdrek3, a.kdrek4, a.kdrek5, a.kdrek6, rek.Ur_Rk6 AS nmrek6,
									...
									GROUP BY a.kdprogram, a.kdkegiatan, a.kdsubkegiatan, a.nmprogram, a.nmkegiatan, a.nmsubkegiatan, a.kdrek1, a.kdrek2, a.kdrek3, a.kdrek4, a.kdrek5, a.kdrek6, rek.Ur_Rk6
			...
			$rincianSubkegiatan = DB::select("WITH anggaran AS (								
									...
									spj_ini_gu AS (
										...
										(
											...
											GROUP BY A.Ko_Period, A.Ko_sKeg1, A.Ko_sKeg2, A.ko_rkk
											UNION ALL
											SELECT A.Ko_Period, A.Ko_sKeg1, A.Ko_sKeg2, A.ko_rkk, SUM(A.To_Rp) AS nilai
