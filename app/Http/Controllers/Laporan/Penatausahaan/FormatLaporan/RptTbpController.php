...
class RptTbpController extends Controller
{
    ...
    public static function Laporan()
    {
		...
		// $model = TrnPendBp::getData($this->tahun, $this->idsubunit, $this->no_laporan)->firstOrFail();
        // $modelRinc = $model->getTrnPendBpRinc();
