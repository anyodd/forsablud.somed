...
class RptDaftarPembayaranUtangController extends Controller
{
    ...
    public static function Laporan($tahun, $tgl_1, $tgl_2)
    {
		...
		$unit = DB::SELECT("SELECT CONCAT(
		 ...
		 $daftarutang = DB::select("SELECT A.kode, A.ko_unitstr, A.tahun, A.tgl_bukti, B.tgl_terima, C.tgl_setor, A.no_bukti, B.no_bp, C.no_sts, A.Ur_bprc AS uraian,
