...
class RptBukuPengeluaranController extends Controller
{
    ...
    public static function Laporan($tahun, $tgl_1, $tgl_2)
    {
		...
		$rekappdpt = DB::select("WITH rinc_pdpt AS (
								...
								FROM
								(
									SELECT A.Ko_Period AS tahun, B.Ko_unitstr, B.dt_bp AS tgl_bukti, D.No_byr AS no_bukti, 
									...
									GROUP BY A.Ko_Period , B.Ko_unitstr, D.dt_byr, D.No_byr, A.Ko_Rkk
