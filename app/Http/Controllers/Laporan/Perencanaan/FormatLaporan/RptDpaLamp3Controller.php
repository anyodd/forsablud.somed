...
class RptDpaLamp3Controller extends Controller
{
				...
				SELECT
					...
					(    
						...
						FROM (
								...
								WHERE a.Ko_Period = ".$tahun." AND LEFT(a.Ko_unit1,18) = '".$row0->kode_unit."' AND a.Ko_tap = ".$idjnsdokumen_req." AND a.id_tap = ".$idnorev." AND LEFT(a.ko_rkk,2) IN (5) AND a.To_Rp<>0
						) A
			...
			$total=DB::SELECT("SELECT dat.tahun, SUM(dat.jml_pendapatan) AS jml_pendapatan, SUM(dat.jml_operasi) AS jml_operasi,
				...
				FROM (
						...
						FROM (
								...
								pf_bid n ON m.id_bidang=n.id_bidang INNER JOIN
								pf_urus o ON n.id_urus=o.id_urus
								WHERE a.Ko_Period = ".$tahun." AND LEFT(a.Ko_unit1,18) = '".$row0->kode_unit."' AND a.Ko_tap = ".$idjnsdokumen_req." AND a.id_tap = ".$idnorev." AND LEFT(a.ko_rkk,2) IN (5)
						) bel 
					) AS dat
				GROUP BY dat.tahun");
