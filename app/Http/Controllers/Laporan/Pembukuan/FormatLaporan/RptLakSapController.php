...
class RptLakSapController extends Controller
{
    ...
    public static function Laporan($tahun, $tgl_1, $tgl_2)
    {
		...
		$saldoKasLainnya = DB::select("WITH saldo_berjalan AS ( 
						...
						SELECT
							...
							a.kd_arus, a.kdrek1, a.kdrek2, a.kdrek3, a.nmrek3, a.kdrek4, a.nmrek4, (SUM(a.saldo_sa) + SUM(saldo)) AS saldo, SUM(a.saldo_sa) AS saldo_sa
						FROM
						(
