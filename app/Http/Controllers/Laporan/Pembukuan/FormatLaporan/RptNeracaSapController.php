...
class RptNeracaSapController extends Controller
{
    ...
    public static function Laporan($tahun, $tgl_2)
    {
		...
		$neraca = DB::select("WITH saldo_berjalan AS
                    (
                        SELECT temp1.tahun, temp1.kdrek1, temp1.kdrek2, temp1.kdrek3, temp1.kdrek4,
                            ...
                            CASE
                                ...
                                WHEN temp1.kdrek1 = 3 THEN temp1.kredit - temp1.debet
								WHEN temp1.kdrek1 = 3 AND temp1.kdrek2 = 1 AND temp1.kdrek3 = 1 AND temp1.kdrek4 = 0 THEN temp1.kredit - temp1.debet
								WHEN temp1.kdrek1 = 3 AND temp1.kdrek2 = 1 AND temp1.kdrek3 = 1 AND temp1.kdrek4 = 2 THEN temp1.saldo
                                ELSE 0
                            END) AS saldo_tahun_ini
                        FROM
                            (
                                SELECT q.tahun, n.kdrek1, n.kdrek2, n.kdrek3, n.kdrek4, q.debet, q.kredit, 0 AS Saldo
                                FROM tb_saldo q INNER JOIN 
								pf_rek_sap n ON q.kdrek1 = n.Ko_Rk1 AND q.kdrek2 = n.Ko_Rk2 AND q.kdrek3 = n.Ko_Rk3 AND q.kdrek4 = n.Ko_Rk4 AND q.kdrek5 = n.Ko_Rk5		
                                WHERE (q.kdrek1 IN (1,2,3)) AND q.Ko_unitstr = LEFT('".kd_unit()."',18) AND kode = 5 AND CAST(bukti_tgl AS DATE) = CAST('".$tgl_2."' AS DATE)
								UNION ALL
								/*memunculkan nilai surplus defisit lo thn berjalan*/
								SELECT q.tahun, 3, 1, 1, 2, q.debet, q.kredit, q.kredit-q.debet AS saldo
                                FROM tb_saldo q
                                WHERE (q.kdrek1 = 7) AND q.Ko_unitstr = LEFT('".kd_unit()."',18) AND kode = 5 AND CAST(bukti_tgl AS DATE) = CAST('".$tgl_2."' AS DATE)
								UNION ALL
								SELECT q.tahun, 3, 1, 1, 2, q.debet, q.kredit, -(q.debet-q.kredit) AS saldo
                                FROM tb_saldo q
                                WHERE (q.kdrek1 = 8) AND q.Ko_unitstr = LEFT('".kd_unit()."',18) AND kode = 5 AND CAST(bukti_tgl AS DATE) = CAST('".$tgl_2."' AS DATE)
                            ) temp1
                    ...
                    (
                        ...
                        FROM
                        (
                            SELECT w.Ko_Period AS tahun, n.kdrek1, n.kdrek2, n.kdrek3, n.kdrek4, 
							CASE
                            ...
                            FROM tb_soaw w LEFT JOIN
								...
								pf_rek_sap n ON b.Ko_Rk1 = n.Ko_Rk1 AND b.Ko_Rk2 = n.Ko_Rk2 AND b.Ko_Rk3 = n.Ko_Rk3 AND b.Ko_Rk4 = n.Ko_Rk4 AND b.Ko_Rk5 = n.Ko_Rk5	
                    ...
                    SELECT
                    a.kdrek1, d.nmrek1, a.kdrek2, c.nmrek2, a.kdrek3, b.nmrek3, SUM(a.saldo_awal) AS saldo_awal, SUM(a.saldo_akhir) AS saldo_akhir
                    FROM saldo_total a
                    INNER JOIN pf_sap3 b ON a.kdrek1 = b.kdrek1 AND a.kdrek2 = b.kdrek2 AND a.kdrek3 = b.kdrek3
                    INNER JOIN pf_sap2 c ON a.kdrek1 = c.kdrek1 AND a.kdrek2 = c.kdrek2
                    INNER JOIN pf_sap1 d ON a.kdrek1 = d.kdrek1
                    GROUP BY a.kdrek1, d.nmrek1, a.kdrek2, c.nmrek2, a.kdrek3, b.nmrek3
