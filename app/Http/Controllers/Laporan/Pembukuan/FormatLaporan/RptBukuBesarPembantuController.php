...
class RptBukuBesarPembantuController extends Controller
{
    ...
    public static function Laporan($tahun, $tgl_1, $tgl_2, $kdrek1, $kdrek2, $kdrek3, $kdrek4, $kdrek5, $kdrek6)
    {
		...
		$daftarBuktiBukuBesar = DB::select("WITH bukti_buku_besar AS (
                        ...
                        (
                            SELECT
								1 AS kode, LEFT(aa.Ko_Rkk,2) AS kdrek1, SUBSTRING(aa.Ko_Rkk,4,2) AS kdrek2, 
								SUBSTRING(aa.Ko_Rkk,7,2) AS kdrek3, SUBSTRING(aa.Ko_Rkk,10,2) AS kdrek4, SUBSTRING(aa.Ko_Rkk,13,3) AS kdrek5, RIGHT(aa.Ko_Rkk,4) AS kdrek6, b.Ur_Rk6 AS nmrek6, 
								a.dt_bukti AS tgl_bukti, a.Buktijr_No AS no_bukti, b.Ur_Rk6 AS uraian, e.SN_rk3 AS saldo_normal, 
								SUM(a.jrRp_K) AS debet, SUM(a.jrRp_D) AS kredit, f.Ur_Rk6 as uraian_lawan, a.Ko_Rkk AS koderekening_lawan
                            FROM jr_trans a INNER JOIN 
								(
									SELECT DISTINCT a.Ko_Period, a.Buktijr_No, a.Ko_unitstr, a.Ko_Rkk FROM jr_trans a
								...
								) aa ON a.Ko_Period=aa.Ko_Period AND a.Buktijr_No=aa.Buktijr_No AND a.Ko_unitstr=aa.Ko_unitstr LEFT JOIN
								". $pf_rk6 . " b ON LEFT(aa.Ko_Rkk,2) = b.Ko_Rk1 AND SUBSTRING(aa.Ko_Rkk,4,2) = b.Ko_Rk2 AND SUBSTRING(aa.Ko_Rkk,7,2) = b.Ko_Rk3 AND SUBSTRING(aa.Ko_Rkk,10,2) = b.Ko_Rk4 AND SUBSTRING(aa.Ko_Rkk,13,3) = b.Ko_Rk5 AND RIGHT(aa.Ko_Rkk,4) = b.Ko_Rk6 INNER JOIN
								...
								pf_rk3 e ON d.Ko_Rk1 = e.Ko_Rk1 AND d.Ko_Rk2 = e.Ko_Rk2 AND d.Ko_Rk3 = e.Ko_Rk3 LEFT JOIN
								". $pf_rk6 . " f ON LEFT(a.Ko_Rkk,2) = f.Ko_Rk1 AND SUBSTRING(a.Ko_Rkk,4,2) = f.Ko_Rk2 AND SUBSTRING(a.Ko_Rkk,7,2) = f.Ko_Rk3 AND SUBSTRING(a.Ko_Rkk,10,2) = f.Ko_Rk4 AND SUBSTRING(a.Ko_Rkk,13,3) = f.Ko_Rk5 AND RIGHT(a.Ko_Rkk,4) = f.Ko_Rk6 
                            WHERE a.Ko_Rkk<>aa.Ko_Rkk
							GROUP BY aa.Ko_Rkk, a.dt_bukti, a.Buktijr_No, a.jr_urbprc , e.SN_rk3, b.Ur_Rk6, f.Ur_Rk6, a.Ko_Rkk 
                            UNION ALL
							SELECT
								1 AS kode, LEFT(aaa.Ko_Rkk,2) AS kdrek1, SUBSTRING(aaa.Ko_Rkk,4,2) AS kdrek2, 
								SUBSTRING(aaa.Ko_Rkk,7,2) AS kdrek3, SUBSTRING(aaa.Ko_Rkk,10,2) AS kdrek4, SUBSTRING(aaa.Ko_Rkk,13,3) AS kdrek5, RIGHT(aaa.Ko_Rkk,4) AS kdrek6, b.Ur_Rk6 AS nmrek6, 
								a.dt_sesuai AS tgl_bukti, a.Sesuai_No AS no_bukti, b.Ur_Rk6 AS uraian, e.SN_rk3 AS saldo_normal,
								SUM(a.Rp_K) AS debet, SUM(a.Rp_D) AS kredit, f.Ur_Rk6 as uraian_lawan, a.Ko_Rkk AS koderekening_lawan
                            FROM jr_sesuai a INNER JOIN tb_sesuai aa ON a.Sesuai_No=aa.Sesuai_No AND a.Ko_unitstr=aa.Ko_unitstr INNER JOIN 
								(
									SELECT DISTINCT a.Ko_Period, a.Sesuai_No, a.Ko_unitstr, a.Ko_Rkk FROM jr_sesuai a
									WHERE a.Ko_Period = ".$tahun." AND CAST(a.dt_sesuai AS DATE) BETWEEN CAST('".$tgl_1."' AS DATE) AND CAST('".$tgl_2."' AS DATE) AND a.Ko_unitstr = LEFT('".kd_unit()."',18)
										AND LEFT(a.Ko_Rkk,2) LIKE '%".$kdrek1."' AND SUBSTRING(a.Ko_Rkk,4,2) LIKE '%".$kdrek2_req."' AND SUBSTRING(a.Ko_Rkk,7,2) LIKE '%".$kdrek3_req."'
										AND SUBSTRING(a.Ko_Rkk,10,2) LIKE '%".$kdrek4_req."' AND SUBSTRING(a.Ko_Rkk,13,3) LIKE '%".$kdrek5_req."' AND RIGHT(a.Ko_Rkk,4) LIKE '%".$kdrek6_req."'
								) aaa ON a.Ko_Period=aaa.Ko_Period AND a.Sesuai_No=aaa.Sesuai_No AND a.Ko_unitstr=aaa.Ko_unitstr LEFT JOIN
								". $pf_rk6 . " b ON LEFT(aaa.Ko_Rkk,2) = b.Ko_Rk1 AND SUBSTRING(aaa.Ko_Rkk,4,2) = b.Ko_Rk2 AND SUBSTRING(aaa.Ko_Rkk,7,2) = b.Ko_Rk3 AND SUBSTRING(aaa.Ko_Rkk,10,2) = b.Ko_Rk4 AND SUBSTRING(aaa.Ko_Rkk,13,3) = b.Ko_Rk5 AND RIGHT(aaa.Ko_Rkk,4) = b.Ko_Rk6 INNER JOIN
								pf_rk5 c ON b.Ko_Rk1 = c.Ko_Rk1 AND b.Ko_Rk2 = c.Ko_Rk2 AND b.Ko_Rk3 = c.Ko_Rk3 AND b.Ko_Rk4 = c.Ko_Rk4 AND b.Ko_Rk5 = c.Ko_Rk5 INNER JOIN
								pf_rk4 d ON c.Ko_Rk1 = d.Ko_Rk1 AND c.Ko_Rk2 = d.Ko_Rk2 AND c.Ko_Rk3 = d.Ko_Rk3 AND c.Ko_Rk4 = d.Ko_Rk4 INNER JOIN
								pf_rk3 e ON d.Ko_Rk1 = e.Ko_Rk1 AND d.Ko_Rk2 = e.Ko_Rk2 AND d.Ko_Rk3 = e.Ko_Rk3 LEFT JOIN
								". $pf_rk6 . " f ON LEFT(a.Ko_Rkk,2) = f.Ko_Rk1 AND SUBSTRING(a.Ko_Rkk,4,2) = f.Ko_Rk2 AND SUBSTRING(a.Ko_Rkk,7,2) = f.Ko_Rk3 AND SUBSTRING(a.Ko_Rkk,10,2) = f.Ko_Rk4 AND SUBSTRING(a.Ko_Rkk,13,3) = f.Ko_Rk5 AND RIGHT(a.Ko_Rkk,4) = f.Ko_Rk6 
							 WHERE a.Ko_Rkk<>aaa.Ko_Rkk
							GROUP BY aaa.Ko_Rkk, a.dt_sesuai, a.Sesuai_No, b.Ur_Rk6, e.SN_rk3, f.Ur_Rk6, a.Ko_Rkk  
                            UNION ALL							
                            SELECT
								...
								SUM(a.soaw_Rp_D) AS debet, SUM(a.soaw_Rp_K) AS kredit, 'Saldo Awal' AS uraian_lawan, '' as koderekening_lawan
                    ...
                    *
                    ...
                    (
                        SELECT
                            0 AS kode, a.kdrek1, a.kdrek2, a.kdrek3, a.kdrek4, a.kdrek5, a.kdrek6, a.nmrek6, CAST('".$tgl_1."' AS DATE) AS tgl_bukti, '' AS no_bukti, 'Saldo Awal' AS uraian, a.saldo_normal, SUM(a.debet) AS debet, SUM(a.kredit) AS kredit, a.uraian_lawan, a.koderekening_lawan
                        FROM bukti_buku_besar a
                        WHERE CAST(a.tgl_bukti AS DATE) < CAST('".$tgl_1."' AS DATE) OR a.kode = 0
                        GROUP BY a.kdrek1, a.kdrek2, a.kdrek3, a.kdrek4, a.kdrek5, a.kdrek6, a.nmrek6, a.saldo_normal, a.uraian_lawan, a.koderekening_lawan
                        UNION ALL
                        SELECT
                            a.kode, a.kdrek1, a.kdrek2, a.kdrek3, a.kdrek4, a.kdrek5, a.kdrek6, a.nmrek6, a.tgl_bukti, a.no_bukti, a.uraian, a.saldo_normal, a.debet, a.kredit, a.uraian_lawan, a.koderekening_lawan
                        FROM bukti_buku_besar a
