...
class RptLraController extends Controller
{
    ...
    public static function Laporan($tahun, $tgl_1, $tgl_2)
    {
		...
		$query = DB::select("WITH anggaran AS (
						...
						FROM temp
						LEFT JOIN pf_rk1 AS rek1 ON temp.kdrek1 = rek1.Ko_Rk1
						...
						SELECT
								...
								SUM(temp.nilaiRealisasiperiodelalu) AS nilaiRealisasiperiodelalu
						FROM temp
						LEFT JOIN pf_rk2 AS rek2 ON temp.kdrek1 = rek2.Ko_Rk1 AND temp.kdrek2 = rek2.Ko_Rk2
						...
						SELECT
								...
								SUM(temp.nilaiRealisasiperiodelalu) AS nilaiRealisasiperiodelalu
						FROM temp
						LEFT JOIN pf_rk3 AS rek3 ON temp.kdrek1 = rek3.Ko_Rk1 AND temp.kdrek2 = rek3.Ko_Rk2 
								AND temp.kdrek3 = rek3.Ko_Rk3
						...
						SELECT
								...
								SUM(temp.nilaiRealisasiperiodelalu) AS nilaiRealisasiperiodelalu
						FROM temp
						LEFT JOIN pf_rk4 AS rek4 ON temp.kdrek1 = rek4.Ko_Rk1 AND temp.kdrek2 = rek4.Ko_Rk2
						...
						SELECT
								...
								SUM(temp.nilaiRealisasiperiodelalu) AS nilaiRealisasiperiodelalu
						FROM temp
						LEFT JOIN pf_rk5 AS rek5 ON temp.kdrek1 = rek5.Ko_Rk1 AND temp.kdrek2 = rek5.Ko_Rk2
						...
						SELECT
								...
								SUM(temp.nilaiRealisasiperiodelalu) AS nilaiRealisasiperiodelalu
						FROM temp
						LEFT JOIN ". $pf_rk6 . " AS rek6 ON temp.kdrek1 = rek6.Ko_Rk1 AND temp.kdrek2 = rek6.Ko_Rk2
