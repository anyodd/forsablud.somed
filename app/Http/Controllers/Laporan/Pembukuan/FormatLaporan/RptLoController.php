...
class RptLoController extends Controller
{
    ...
    public static function Laporan($tahun, $tgl_2)
    {
		...
		$rincianLO = DB::select("WITH saldo_berjalan AS
                    (
                        SELECT temp1.tahun, temp1.kdrek1, temp1.kdrek2, temp1.kdrek3,
                            SUM(
                            CASE
                                WHEN temp1.kdrek1 = 8 THEN temp1.debet - temp1.kredit
                                WHEN temp1.kdrek1 = 7 THEN temp1.kredit - temp1.debet
                                ELSE 0
                        ...
                        FROM
                            (
                                ...
                                FROM tb_saldo q
                                WHERE (q.kdrek1 IN (7,8)) AND q.Ko_unitstr = LEFT('".kd_unit()."',18) AND kode = 4 AND CAST(bukti_tgl AS DATE) = CAST('".$tgl_2."' AS DATE)
                            ) temp1
                    ...
                    (
						...
						(
							SELECT temp1.tahun,
								CONCAT(temp1.kdrek1,'.',temp1.kdrek2,'.',RIGHT(CONCAT('0', temp1.kdrek3), 2)) AS koderekening,
								temp1.kdrek1, rek1.Ur_Rk1 AS nmrek1, temp1.kdrek2, rek2.Ur_Rk2 AS nmrek2, temp1.kdrek3, rek3.Ur_Rk3 AS nmrek3,
							...
							(
								...
								INNER JOIN pf_rk3 rek3 ON temp1.kdrek1 = rek3.Ko_Rk1 AND temp1.kdrek2 = rek3.Ko_Rk2 AND temp1.kdrek3 = rek3.Ko_Rk3
								INNER JOIN pf_rk2 rek2 ON temp1.kdrek1 = rek2.Ko_Rk1 AND temp1.kdrek2 = rek2.Ko_Rk2
								INNER JOIN pf_rk1 rek1 ON temp1.kdrek1 = rek1.Ko_Rk1
							GROUP BY temp1.tahun, temp1.kdrek1, rek1.Ur_Rk1, temp1.kdrek2, rek2.Ur_Rk2, temp1.kdrek3, rek3.Ur_Rk3
						) temp2
						WHERE temp2.koderekening NOT LIKE '7.4%' AND temp2.koderekening NOT LIKE '8.4%' AND temp2.koderekening NOT LIKE '8.5%'
                    )
                    SELECT
                    ...
                    UNION ALL
                    SELECT
                        CONCAT(kdrek1,'.',kdrek2) AS koderekening, nmrek2 AS uraian, SUM(saldo_tahun_ini) AS saldo_tahun_ini, SUM(saldo_tahun_lalu) AS saldo_tahun_lalu,
                        SUM(saldo_tahun_ini)-SUM(saldo_tahun_lalu) AS kenaikan_penurunan
                    FROM LO
		...
		$rincianLO2 = DB::select("WITH saldo_berjalan AS
                    ...
                    (
						...
						WHERE temp2.koderekening LIKE '7.4%' OR temp2.koderekening LIKE '8.5%'
                    )
                    SELECT koderekening, nmrek3 AS uraian, SUM(saldo_tahun_ini) AS saldo_tahun_ini, SUM(saldo_tahun_lalu) AS saldo_tahun_lalu,
						SUM(saldo_tahun_ini)-SUM(saldo_tahun_lalu) AS kenaikan_penurunan
					FROM LO
					GROUP BY koderekening,nmrek3
					ORDER BY koderekening");
		$rincianLO3 = DB::select("WITH saldo_berjalan AS
                    ...
                    (
						...
						WHERE temp2.koderekening LIKE '8.4%'
                    )
                    SELECT koderekening,nmrek3 AS uraian, SUM(saldo_tahun_ini) AS saldo_tahun_ini, SUM(saldo_tahun_lalu) AS saldo_tahun_lalu,
						SUM(saldo_tahun_ini)-SUM(saldo_tahun_lalu) AS kenaikan_penurunan
					FROM LO
